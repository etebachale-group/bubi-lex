...
INSERT INTO dictionary_entries (
 ...
 ('opatyáballá', 's.', NULL, NULL, NULL, NULL, 'sing. hablante, comunicante. Cl. 1', NULL, 'tóritóri', 'Fuente: bubi-español', 'import-script'),
 ('opatyí', 's.', NULL, NULL, NULL, NULL, 'sing. cesto grande. palangana grande. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ope', 's.', NULL, NULL, NULL, NULL, 'sing. vagabundeo. ligue. Cl. 7 ; o bella e - ir de ligue, n la e - estoy de ligue', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ope''e', 's.', NULL, NULL, NULL, NULL, 'sing. burla, broma. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('opello', 's.', NULL, NULL, NULL, NULL, 'sing. burlón, bufón. Cl. 1', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opelopello', 's.', NULL, NULL, NULL, NULL, 'sing. burla. Cl. 3. Tb. lopelopello, lopelello', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('opeppa', 's.', NULL, NULL, NULL, NULL, 'sing. pintor. blanqueador. Cl. 1', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opepúu', 's.', NULL, NULL, NULL, NULL, 'sing. hueso de la pierna, canilla. Cl. 3. operi, pret. v. o opella ; e aríolla - lelle sóté la anciana arrancó la hierba. . . muy bien. operi, 1. pret. v. o opella ; e neppí e le - o bosari el músico toco la canción para mí. 2. s. sing. asam blea, reunión, encuentro. Cl. 7. opessi, pret. v. o oppa ; e sipóssi si -la o bubá bo e tyué el gato se atragantaba con la espina. opessi, pret. v. o oppa ; balo ibbO ba - estos demonios tardaban. ópessi, pret. v. o óppa ; n yo pegaba, bo - tú pegabas, o - él pegaba, to - nosotros pegá bamos, lo - vosotros pegabais, ba ellos pegaban', NULL, 'eoperi', 'Fuente: bubi-español', 'import-script'),
 ('opetté', 's.', NULL, NULL, NULL, NULL, 'sing. cuerda. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opetyíi', 's.', NULL, NULL, NULL, NULL, 'sing. amargura, amargo, picazón. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opetyípetyíi', 's.', NULL, NULL, NULL, NULL, 'sing. picor. excitación sexual. Cl. 3. opelessi, pret. v. o opella ; o bOloari a séi lá e raatyé wela n M - e kittá al enfermo, mientras estuvo en la cama, yo le toca ba la guitarra. i', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opilo', 's.', NULL, NULL, NULL, NULL, 'sing. botella. Cl. 3. Tb. miikoteri, hiikoteri, iipoteri', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opippa', 's.', NULL, NULL, NULL, NULL, 'sing. dictador, tirano. el. l', NULL, 'mmaUa', 'Fuente: bubi-español', 'import-script'),
 ('opippo', 's.', NULL, NULL, NULL, NULL, 'sing. naranjo. Cl. 3. Tb. hiirelÍtya', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('opopoo', 's.', NULL, NULL, NULL, NULL, 'sing. charla, conversación, plática, par lamento. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opoppo', 's.', NULL, NULL, NULL, NULL, 'sing. árbol de la papaya. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('oposa', 's.', NULL, NULL, NULL, NULL, 'sing. jactancia, presunción. Cl. 7', NULL, 'eiipiisa y iipóssa', 'Fuente: bubi-español', 'import-script'),
 ...
 ('opóssa', 's.', NULL, NULL, NULL, NULL, 'sing. jactancia, presunción. Cl. 3. Tb. iipiisa y ityiikó', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opoteri', 's.', NULL, NULL, NULL, NULL, 'sing. botella. Cl. 3. Tb. apilo, miikiJteri, hiikiJteri. opotessi, pret. v. o opotta ; a boppé ba -la e itohí el agua hervía con el sol', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('opotobílla', 's.', NULL, NULL, NULL, NULL, 'sing. palma real. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('opuppu', 's.', NULL, NULL, NULL, NULL, 'sing. serbal. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opuputtu', 's.', NULL, NULL, NULL, NULL, 'sing. enjambre. Cl. 7. Tb. iikiipuUú', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opúríi', 's.', NULL, NULL, NULL, NULL, 'sing. oriundo. Cl. 1', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('opussu', 's.', NULL, NULL, NULL, NULL, 'sing. juego, diversión, pasatiempo. Cl. 3. oráa, v. enviar, mandar; a bayolla ba áó ba lá - bohullá buebue nuestros abuelos envían una buena ben dición. Pret. oóa, oresiia', NULL, 'o ará', 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('pando', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. cabañas, chozas. . Tb. wetya', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('papá''á', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. verruga/s. Cls. 9 y 10. papaba, V. palpitar, latir; o botébbá lÍl bo lá - mi corazón palpi ta. Pret. papabi, papabessi. papabessi, pret. V. o papaba ; o botébbá bo boyolla bo - el corazón del abuelo palpitaba. papabi, pret. V. o papaba ; bo - o botébbá o palpitó tu corazón. papabia, V. palpitar, latir; o botébbá l Í l bo lá - kóri n la salláa mi corazón palmita por que tengo miedo. Pret. papabiia, papabiesiia. papabiesüa, pret. V. o papabia ; o botébbá lÍl bo - bakasso mi corazón latía deprisa. papabiia, pret. V. o papabia ; bo o botébbá bo áí pal pitó su corazón. papálea, V. revolcarse; o bulla a la - e raatyé puá la donce lla se revuelca en la cama; o boie a tyí a - a anno el hombre no se revuelca en el suelo. Pret. papálei, papáleseei. papálei, pret. V. o papálea ; o bulla a - a boppé wela la doncella se revolcó en el agua. papáleseei, pret. v. o papálea ; o bulla a - a wéi la o oberíi áí la doncella se revol caba en el suelo cuando murió su madre. papara, v. revolcar, r', NULL, 'o papahia', 'Fuente: bubi-español', 'import-script'),
 ('pappa', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. cuña, calzo, falca. els. 9 y lO', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('páppo', 's.', NULL, NULL, NULL, NULL, 'pl. techados, tinglados. Cl. 10. para, v. ofrendar para obtener algo; o - robbo ofrendar para obtener algo a cambio. Pret. pariia, paresiia. paráa, v. hacer llegar; o botákko a la - o botólló el embajador hace llegar el mensaje. *0 - botákko comunicar. Pret. paríia, paresiia. parabia, pret. v. o parabia ; i tyué n i - el pescado lo freÍ. parabia, v. freír; n la - i tyué yo frío el pescado. Pret. parabia, parabie siia. parabiesiia, pret. v. o parabia ; n- e bekobbe behótóttó yo freía los plátanos maduros', NULL, 'o tyetyéra', 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('peléte', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. plato. Cls. 9 y 10; e - he el plato nuevo, e - kolólló el plato vie jo, e - e báteri é el plato lla no, e - e tyíréia é el plato hondo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('pellá', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. anguila. Cls. 9 y 10. pella, v. llegar, llegar a ser; abé ntá ba lá - o wetya los señores llegan a la cabaña. Pret. peem, pelessi. pélla, v. 1. vivir, habitar, hospedar; n la - hállo yo vivo aquí. 2. cesar; o lOé 10 lá - bakasso el lloro cesa deprisa. 3. efec tuar. * 0-iIIo sentarse. Pret. péém, pélessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pellé', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. un tipo de serpiente, víbora. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pello', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. burlas, mofas, desprecios, ignomi nias, desaires. deshonores, vergüenzas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('pEPa', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. caracol de río. Clases 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pepapeppa', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. gris. tierra grisá cea. Cls. 9 y 10. 266 / Pepekuku', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('pepelle', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. tobillo/s. Cls. 9 y 10. Tb. kekesse, pepenna', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pepenna', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. tobillo/s. Cls. 9 y 10. Tb. kekesse, pepelle. pépessi, pret. v. o péppa ; o bOoáooa ro a - a abaUá mi abuela enrollaba los rollitos de malanga. pepólessi, pret. v. o pepólla ; o - e ion o yo desen rollaba el nudo. Tb. pepueessi. pepólla, v. desdoblar, desenrollar; e aríolla e lá - e eppáa la anciana desenrolla la pulsera de tyíbbo. Pret. pepóm, pepólessi. pepóm, pret. v. o pepólla ; oe - e iIloo desenrollé el nudo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('peppa', 's.', NULL, NULL, NULL, NULL, 'pl. caolín, mineral de arcilla blanca y dura. Clase 10. péppa, v. enrollar, doblar, devanar; tyuíi - se e sipéppa por favor dobla el papel. Pret. péppi, pépessi. peppáa, v. doblar, enrollar; o la ri - e ripép pa yo 10 enrollo, el docu mento. Pret. peppíi, pepessi', NULL, 'kalabátyoko', 'Fuente: bubi-español', 'import-script'),
 ('peppe', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. remedio, fo rma, manera. Cls. 9 y 10; ha tyí - no hay remedio', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('peppe', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. telarañas. . péppi, pret. v. o péppa ; o - yo enrollé, yo doblé, o - tú enrollaste, tú doblaste, a - él o ella enrolló, él o/ella dobló, to - nosotros enrollamos, nosotros doblamos, 10 vosotros enrollasteis, vosotros doblasteis, ba ellos enrollaron, ellos doblaron. peppíi, pret. v. o peppáa ; e ripeppe ri e ribobo la telaraña enrolló a la araña. pepueessi, pret. v. o pepólla ; o - e inoo yo desenrolla ba el nudo. Tb. pepólessi, pera, v. hacer llegar, llevar; bolo bo''e o la bO - obessé esta carga lo haces llegar al poblado. Pret. periia, peresiia. peráera, v. quejarse porque a uno le toca siem pre hacer las cosas. Pret. pemeriia, peráeressia. peraeriia, pret. v. peráera. peráeressia, pret. v. o peráera. péréa, v. cruzar, atravesar; 10 la- o bokoo vosotros cruzáis la calle. saltar u n obstáculo; to la - o boakká nosotros saltamos la acequia. Pret. péréi, péréseei. péréi, pret. v. o péréa ; mpári o - o boakká ayer salté la acequia. péreseei, pret. v. o péréa ; o boakká to bo - la aceq', NULL, 'apeppe', 'Fuente: bubi-español', 'import-script'),
 ('perí', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. veneno. Cls. 9 y lO. peri, pret. v. o pella ; o - sornó llegué a ser valiente, o ta - sornó no llegué a ser valiente, o - botyo llegaste a ser alguien, o bollá a ta bOtyo el niño no llegó a ser alguien, no llegó a vivir. Tb. peem. periia, pret. v. o pera ; o r notóo bo le - otottto el coche me llevó lejos', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('petyoo', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. objeto con el que se apunta la algo. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pi''e', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. pez colorado, breca. Clases 9 y 10', NULL, 'bi''a', 'Fuente: bubi-español', 'import-script'),
 ('pi''í', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. agujero, hoyo. Clases 9 y 10', NULL, 'bOlló', 'Fuente: bubi-español', 'import-script'),
 ('pi''o', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. riñón. Clases 9 y 10. piessi, pret. v. o piia ; túe tue nosotros nos íbamos. pii, pret. v. o piia ; e hOtúkku botee n ke - oh gran alcalde, me he ido. piia, v. irse, marcharse; - e ¡vete, már chate! Pret. pii, piessi', NULL, 'bi''o', 'Fuente: bubi-español', 'import-script'),
 ('píín', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. alfiler, aguja. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pikko', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. pico. Cls. 9 y 10. pilelessi, pret. v. o pilella ; 010 botyo n bo bitékobbo a esta persona le plantaba troncos. pilella, v. plantar o fijar un poste o un palo en la tierra para alguien. Pret. pileri, pilelessi. pileri, pret. v. o pilella ; e eyári lÍl wela ne biho''o en mi par cela planté postes. pilessi, pret. v. o pilla ; n - bitekobbo la biho''o yo fij aba troncos y postes en la tierra', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pillá', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. dátil de la palmera de aceite. Cls. 9 y 10. pilla, v. plantar o fijar un poste o un palo en la tierra; 10 la - batté vosotros plantáis postes. Pret. piri, pilessi. pipea, v. adornarse, engalanarse, acicalarse; a bakuerakueráa ba lá - Iello los estudiantes se engalanan hoy. Pret. pipei, pipeseei. pipei, pret. v. o pipea ; o bulla a''a - mpári la doncella se engalanó ayer. pipelessi, pret. v. o pipella ; o wettalÍl n bo - o bOllá áí a mi hermana le engalanaba a su hijo. pipella, v. adornar para, engalanar para; to la - e eriia kóri he ripelló nosotros adornamos el pueblo porque hay fiesta. Pret. piperi, pipelessi. piperi, pr et. v. o pipella ; ne - e tyóbbo lÍl adorné mi casa. pipeseei, pret. v. o pipea ; to - kóri to séi ripelló nos engalanábamos porque estábamos de fiesta. pipessi, pr et. v. o pippa ; o loa lullé a batyo bammaa ba - i tyóbbo yábbO el año pasado todas las personas adornaban sus casas. pippa, v. adornar, engalanar, decorar, or namentar; a batyo ba lá - a batté', NULL, 'nammo', 'Fuente: bubi-español', 'import-script'),
 ('pippo', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. adornos, ornamentos. limpie zas, pulcritud. . piri, pret. v. o pilla ; a batyo bammaa ba - e biho''o todas las personas plantaron los postes', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pisíssi', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. retazo, trapo, gamuza. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('pittóo', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. silbato, pito, claxon, bocina. Cls. 9 y 10. pityi, pret. v. o pitta ; n ta - o sá e elakom no pude hacer mi trabajo, e lo baie to''a - señores, hemos recibido algo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('po''a', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. mono, macaco. Cls. 9 y 10. poalelessi, pret. v. o poalella ; a batyo ba mmaa ba - todas las personas se daban las manos. poalella, v. darse las manos; to la nos damos las manos. Pret. poaleri, poalelessi. poaleri, pr et. v. o poalella ; n o boríbáa yo di la mano al extranjero. pobba, v. charlar, conversar, parlamentar, pla ticar; a batyo ba lá - las personas charlan. Pret. pobbi, pobessi. pobbá, v. burlarse, reírse de alguien, mofarse, despreciar; o la le -? ¿te ríes de mí? Pret. pobbí, pobessi. póbba, v. reventar, explotar, reventarse, deto nar; o buellá o bo lá - tu vientre revienta. Pret. póbbi, póbessi. pobbi, pret. v. o pobba ; a batyo appa lé ba - Ielle las dos personas charlaron muy bien. pobbí, pr et. v. o pobbá ; n-o botyo me burlé de la persona. póbbi, pret. v. o póbba ; e etue áí e - su cabeza reventó. póbbia, v. reventar, explotar, hacer reventar, hacer explotar, detonar; a bakuerakueráa ba lá - e ibolobOlló los alumnos hacen reventar los glo bos. Pret. póbiia, ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pofupOfu', 's.', NULL, NULL, NULL, NULL, 'sing. bollo, buñuelo. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pohá', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. hazaña, fechoría, desmán, hecho o trabajo asombroso, insólito. Cls. 9 y 10; a bayoUa báó ba sessí i - nuestros abuelos reali zaban hechos asombrosos', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pokette', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. bolsillo. ahorros. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pókkó', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. buey, toro, vaca. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('possáa', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. monedero, cartera. bolso. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('potobílla', 'S.', NULL, NULL, NULL, NULL, 'sing. y pl. palo jabón. Clases 9 y 10. potóo, int. gracias. potóo, inl. gracias. pótta, V. cazar al vuelo con algún objeto; n la - sinorí cazo un pájaro. coger del árbol con algún objeto n la - bireñtya cojo naranjas del árbol con algún objeto. Pret. pótyi, pótessi', NULL, 'potóo', 'Fuente: bubi-español', 'import-script'),
 ...
 ('púrúu', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. puerta, entrada. Cls. 9 y 10. pusalessi, pret. v. o puusalla ; a bakuerakueráa ba - bireÍltya los alumnos jugaban con naranjas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('pussa', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. aceitera. Cls. 9 y 10. putessi, pret. v. o putta ; i puá i los perros escarbaban. purta, v. escarbar, cavar; e péláká e lá - el topo escarba. Pret. putyi, putessi. putyi, pret. v. o putta ; e kólló e o bobba la rata escarbó la tierra', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('putyú', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. cólico, indigestión. Clases 9 y 10. puusalla, v. jugar con, divertirse con; 10 la e empa vosotros jugáis con el asiento, lue puusalleempa no juguéis con el asiento. Pret. pusaam, pusalessi. puusam, pret. v. o puusalla ; n ka bo - o bonatú''o áí jugué con su hermano mayor. puuselessi, pret. v. o puusella ; to - e riOssa puá nosotros jugábamos en el estadio. puusella, v. divertirse o jugar por/para; a baie ba la - e eriia los hombres juegan por el pueblo. Pret. puuseri, puuselessi. puuseri, pret. v. o puusella ; lúe lo - i nalle puá vosotros jugasteis sobre los márboles. puusessi, pret. v. o puussa ; n - yo jugaba, o - tú jugabas, a - él jugaba, to nosotros jugábamos, 10 - vosotros jugabais, ba ellos jugaban. puussa, v. jugar, divertirse; to la - kóri to''a oberi o nosotros nos estamos divirtiendo porque nos han pagado. Pret. puussi, puusessi. puussi, pret. v. o puussa ; e biulla be mmaa be - e suppá todas las doncellas jugaron al fútbol', NULL, 'buttú', 'Fuente: bubi-español', 'import-script'),
 ...
 ('ra', 'conec.', NULL, NULL, NULL, NULL, 'prep. de; rihúla - bisussú un montón de hormigas comunes y rojas. Concuerda con las palabras de la Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('raa''o', 'S.', NULL, NULL, NULL, NULL, 'sing. excremento, hez. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('raakio', 'S.', NULL, NULL, NULL, NULL, 'sing. dictadura. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('raálá', 'S.', NULL, NULL, 'Cl. 5', NULL, 'sing. pierna. . Tb. [opollá, [oponná', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('raam', 'S.', NULL, NULL, NULL, NULL, 'sing. cultura, saber. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('raatyé', 'S.', NULL, NULL, NULL, NULL, 'sing. lecho, cama, catre. Cl. 5. Tb. rassi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rakka', 'S.', NULL, NULL, NULL, NULL, 'sing. víspera de festivo, viernes', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rállo', 'S.', NULL, NULL, NULL, NULL, 'sing. 1. hígado, 2. soberbia. Cl. 5. ralohekka. loc. adv. un instante, momento', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rapápísso', 'S.', NULL, NULL, NULL, NULL, 'sing. anona blanca. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rappáa', 'S.', NULL, NULL, 'Cl. 5', NULL, 'sing. sobaco. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rappí', 'S.', NULL, NULL, NULL, NULL, 'sing. resto, limosna, dádiva. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('re''a', 'S.', NULL, NULL, NULL, NULL, 'sing. ñame de las tres hojas. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('re''áeri', 's.', NULL, NULL, NULL, NULL, 'sing. contagio. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ré''oo', 'S.', NULL, NULL, NULL, NULL, 'sing. puente, pontón. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rebbe', 'S.', NULL, NULL, 'Cl. 6', NULL, 'sing. embarazo. Cl. 5. Tb. riMá. 274 / reeá', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rekera', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. investigación, indagación. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('Resopo', 'antrop.', NULL, NULL, NULL, NULL, 'plural que si¡''''Ilifica "árboles saquientes" o "arcos flecheros". Debería escribir se Besoppo en el primer caso, o Besoppo en el scgundo. Está localizado en Rebola y en Baney. hesoppa, s. pl. caracoles grandes y con la concha de color marrón claro u oscuro. Cl. 4', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ressi', 'S.', NULL, NULL, 'Cl. 10', NULL, 'pl. arroz. . Tb. bollá ba mbobOlló [bollá bá rÍlbobOlIól', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('Reta', 'antrop.', NULL, NULL, NULL, NULL, 'plural de luettáa. Debe r ía escribirse Bettáa. Está localizado en Basaka lo de la Sagrada Familia. betá, 1. adj. numo tres. Concuerda con las palabras de la Cl. 4: beatta - tres historias. 2. adv. quizá; a ta pá''e o pooa quizá no pueda venir', NULL, 'metá', 'Fuente: bubi-español', 'import-script'),
 ...
 ('ri''abba', 'S.', NULL, NULL, NULL, NULL, 'sing. lugar donde se reparten o distri buyen cosas. Cl. 5. ribári / 275', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ri''abbo', 's.', NULL, NULL, NULL, NULL, 'sing. regalo, obsequio, donación. Cl. 5. Tb. ityuho, bOtuho', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ri''é', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. nuez de cola. Cl. 5. Tb. rinké, v. hundirse, naufragar; o buátto M lá la barca se hunde. Pret. ri''ei, ri''esei. ri''ei, pret. v. o ri''ea ; o botyo a -la per sona se hundió. ri''esei, pret. v. o ri''ea ; e emmommo e - el tronco se hundía. ri''essi, pret. v. o ri''a ; o buátto bo - el barco naufragaba. Tb. rikessi. ri''i, pret. v. o ri''a ; o buátto bo - el barco naufragó', NULL, 'rikki', 'Fuente: bubi-español', 'import-script'),
 ('ri''o', 's.', NULL, NULL, NULL, NULL, 'sing. ancla. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ri''ó', 's.', NULL, NULL, NULL, NULL, 'sing. cañaveral. lugar donde abundan las cañas. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ri''otya', 'adj.', NULL, NULL, NULL, NULL, 'sing. primero, primera Concuerda con las palabras de la Cl. 5. efr. riOtya', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ri''uá', 's.', NULL, NULL, NULL, NULL, 'sing. suerte, dicha. Cl. 5 ; to''ú la - a ta bá pala''e la fuerza y la suerte no son compatibles. basoppo be �', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ria''o', 's.', NULL, NULL, NULL, NULL, 'sing. antorcha. Cl. 5. Tb. bOkokko', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('riabbi', 's.', NULL, NULL, NULL, NULL, 'sing. reparto, distribución. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riabbí', 's.', NULL, NULL, NULL, NULL, 'sing. culpabilidad. Cl. 5. Riachó, antrop. que se refiere al lugar donde abundan los buitrones o las ostras. Riaty6 se localiza en Belebú. riáera, v. frotar, borrar; to la - o bobba nosotros frotamos el suelo. Pret. riáe riia, riáeresiia. riáeresüa, pret. v. o riáera ; n - boat ta yo borraba la historia, n-e ribasso yo borraba la pizarra. riáerüa, pret. v. o riáera ; ne - e epánna froté la palangana', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riakka', 's.', NULL, NULL, NULL, NULL, 'sing. menú, plato de comida. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riakkí', 's.', NULL, NULL, NULL, NULL, 'sing. condena, castigo, sentencia. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riakko', 's.', NULL, NULL, NULL, NULL, 'sing. enlace, puntal. incienso natural. Cl. 5 ; e rá e eté rimo el incienso natural de los espíritus', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riakko', 's.', NULL, NULL, NULL, NULL, 'sing. multa, sanción. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('riallá', 's.', NULL, NULL, NULL, NULL, 'sing. mano, . Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riari', 's.', NULL, NULL, NULL, NULL, 'sing. cosecha de dátiles. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riatte', 's.', NULL, NULL, NULL, NULL, 'sing. pedriza, terreno pedregoso, pedre gal. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riatyi', 's.', NULL, NULL, NULL, NULL, 'sing. división, separación, entrada. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riatyó', 's.', NULL, NULL, NULL, NULL, 'sing. lugar donde abundan los buitrones o las ostras. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ribákeri', 's.', NULL, NULL, NULL, NULL, 'sing. revuelta. disturbio. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('riballá', 's.', NULL, NULL, NULL, NULL, 'sing. canelón. rollito de malanga rallada. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribállá', 's.', NULL, NULL, NULL, NULL, 'sing. matrimonio, esposos, desposo rios. pareja de hombre y mujer que conviven. Cl. 5. ribálla, v. extraviarse, perderse; o wetta o a la - o botyíó tu hermana se pierde con la noche. olvidar, olvi darse; n la - e tyé yo olvido el lugar. Pret. ribári, ribálessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribapatyilla', 's.', NULL, NULL, NULL, NULL, 'sing. araña peluda. Cl. 5. ribári, pret. v. o ribálla ; bolo Matta n bo - esta historia lo olvidé. 276 / Ribas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ribasaisso', 's.', NULL, NULL, NULL, NULL, 'sing. incendio, fuego grande. falla. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ribatya', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. palo bifurcado en tres. tri dente, tenedor. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ribé', 'adj.', NULL, NULL, NULL, NULL, 'malo, mala, feo, fea. Concuerda con las palabras de la Cl. 5; ityuho - un regalo feo, rihóle - amor malo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('ribebeppu', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. macho cabrío. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ribekúbeku', 's.', NULL, NULL, NULL, NULL, 'sing. papada, barbilla grande. Cl. 5. ribelessi, pret. v. o ribella ; e ribasaisso ri - el incendio se apagaba. ribella, v. desaparecer, apagarse, extinguir se; i bileri yáó i á la - nuestros bailes desaparecen. Pret. riberi, ribe lessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ribetebette', 's.', NULL, NULL, NULL, NULL, 'sing. trampa, estratagema. Cl. 5. Tb. esello, ehurí', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribeteri', 's.', NULL, NULL, NULL, NULL, 'sing. espera, añoranza. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribetté', 's.', NULL, NULL, NULL, NULL, 'sing. barril, bidón. Cl. 5. Tb. lusiánno', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribetto', 's.', NULL, NULL, NULL, NULL, 'sing. desembocadura. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribetto', 's.', NULL, NULL, NULL, NULL, 'sing. 1. poza. 2. parada. 3. sala de espe ra. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribétto', 's.', NULL, NULL, NULL, NULL, 'sing. 1. ceremonia de prohibición. 2. remanso. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribetye', 's.', NULL, NULL, NULL, NULL, 'sing. escoba. fregona. Cl. 5 ; puráa e-n ubolle e tyóbbo dame la escoba para que barra la casa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribetyi', 's.', NULL, NULL, NULL, NULL, 'sing. espera. Cl. 5. Tb. ribeteri. ribía, pret. v. o ribbiáa ; n-e ripepáa ÓI yo perdí mi docu mentación, n ri - e ripepáa ÓI lo perdí, mi documentación, i konyákko i o boioppé ÓI el coñac emborrachó a mi tío', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribetyí', 's.', NULL, NULL, NULL, NULL, 'sing. espera, esperanza. Cl. 5. Tb. ribetyi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribieri', 's.', NULL, NULL, NULL, NULL, 'sing. nacimiento. Cl. 5. ribieseei, pret. v. o ribeea ; e púrúu e - la puerta se cerraba. ribiesiia, pret. v. o ribbia ; to ri - e ripel ló nosotros cerrábamos la fiesta. ribiesiia, pret. v. o ribbiáa ; n ri - e ribúkku ÓI yo lo perdía, mi libro, a ba''u ba le - el vino de palma me emborrachaba. ríbíi, pret. v. o ribbáa ; o bonánna ÓI a - e ehobbá wela mi abuela se perdió en el bosque. ribiia, pret. v. o ribbia ; n 10 - o IObakka yo lo cerré, el baúl, n-o IObakka yo cerré el baúl', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribinno', 's.', NULL, NULL, NULL, NULL, 'sing. batidora, trituradora. opre sión, dictadura. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('ribissó', 's.', NULL, NULL, NULL, NULL, 'sing. ascensor, montacarga. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribobo', 's.', NULL, NULL, NULL, NULL, 'sing. araña. Cl. 5. Riboho, antrop. cuyo significado nos remite a "cabaña" o "cocina". Se localiza en Sampaka', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribokká', 's.', NULL, NULL, NULL, NULL, 'sing. algo que encoge. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ribolló', 's.', NULL, NULL, NULL, NULL, 'sing. odio, rencor. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribómma', 's.', NULL, NULL, NULL, NULL, 'sing. borrachera. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribóperi', 's.', NULL, NULL, NULL, NULL, 'sing. crianza, cuidado. Cl. 5. Tb. ribóppi ; - rá oberü cuidado materno', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribóppi', 's.', NULL, NULL, NULL, NULL, 'sing. crianza, cuidado. Cl. 5 ; - rá o bOllá el cui dado del niño. Tb. ribóperi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribóra', 's.', NULL, NULL, NULL, NULL, 'sing. arrendamiento, alquiler. Cl. 5. ribori, pret. v. o ribOlla ; elo ebari n-e rohiáa esta mañana abrí el oratorio', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribósekka', 's.', NULL, NULL, NULL, NULL, 'sing. harmónica, acordeón. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribotónbotó', 'adj.', NULL, NULL, NULL, NULL, 'blando, tierno. eoncuerda con las palabras de la Cl. 5; iteke - cangrejo de río blando', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribótyikka', 's.', NULL, NULL, NULL, NULL, 'sing. herpes simple. Cl. 5. ribotyI1la, s. sing. apellido. mote, sobre nombre. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribotyo', 's.', NULL, NULL, NULL, NULL, 'sing. la vida, sociedad. destino. Cl. 5. Ej. expr. e - ri e pa nyá ré to''ú la vida de España es dura', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribuéi', 's.', NULL, NULL, NULL, NULL, 'sing. fallecimiento, defunción, muerte. Cl. 5. Tb. riwéi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribueríi', 's.', NULL, NULL, NULL, NULL, 'sing. comunicación. Cl. 5. ribuessi, pret. v. o ribOlla ; a bayoUa ba - o bosilla los ancianos abrían la cueva', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribukkí', 's.', NULL, NULL, NULL, NULL, 'sing. 1. abundancia, multitud. 2. diver sidad. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('ribúkku', 's.', NULL, NULL, NULL, NULL, 'sing. libro ; a sero anna - es muy culto. Cl. 5. 278 / riburí', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riburí', 's.', NULL, NULL, NULL, NULL, 'sing. salvación, protección. Cl. 5 ; o le peí - me diste protección', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ríe', 's.', NULL, NULL, NULL, NULL, 'sing. río, afluente, arroyo. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('Rieba', 'antrop.', NULL, NULL, NULL, NULL, 'que ofrece dos significados. Cfr. riebba', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riebba', 's.', NULL, NULL, NULL, NULL, 'sing. lugar de festejos. bodega, bar. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riebba', 's.', NULL, NULL, NULL, NULL, 'sing. descanso, huelga. parada. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('rieppa', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. siembra, sembrado. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ríetuetto', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. pechuga. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rietyá', 's.', NULL, NULL, NULL, NULL, 'sing. bizquera. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rietyi', 's.', NULL, NULL, NULL, NULL, 'sing. 1. distancia, recorrido. 2. lugar don de se reunen los amigos. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rietyo', 's.', NULL, NULL, NULL, NULL, 'sing. vía, raíl. Cl. 5. Rigetema, antrop. cuyo significado encontramos en Rijetema. Se localiza en Belebú yen Ruiché. rígóla, v. enderezar; n-o bokussú yo enderezaba el hierro. Pret. rígóri, rígueesi. rígóri, pret. v. o rígóla ; n-o mopen dé yo enderecé la cuerda. rígueesi, pret. v. o rigóla ; to - e bilab ba nosotros enderezábamos los hechos', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ríhe', 'adj.', NULL, NULL, NULL, NULL, 'nuevo, nueva. Concuerda con las pala bras de la Cl. 5; o le péi ribotyo - me diste una nueva vida', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riheIla', 's.', NULL, NULL, NULL, NULL, 'sing. lugar donde se arregla ropa. Cl. 5. Rihepe, antrop. que se refiere al lugar donde abundan las anguilas. Debe ría escribirse Rieppe. Se localiza en Rebola y en Baney', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rihekka', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. modelo. cigarra. mari posa. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riheleri', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. recurso, súplica. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riheperi', 's.', NULL, NULL, NULL, NULL, 'sing. visita. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rihótóttó', 'adj.', NULL, NULL, NULL, NULL, 'blanco, blanca. Concuerda con las palabras de la Cl. 5; robbo - escalera blanca. rikkáa / 279', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rihótyi', 's.', NULL, NULL, NULL, NULL, 'sing. algo que es transparente y brillan te. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('rihúa', 's.', NULL, NULL, NULL, NULL, 'sing. lugar del público. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rihuee', 's.', NULL, NULL, NULL, NULL, 'sing. familia, parentela. Cl. 5 ; tue - somos parientes. Tb. rihoe', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rihuera', 's.', NULL, NULL, NULL, NULL, 'sing. orientación, consejo. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rihúla', 's.', NULL, NULL, NULL, NULL, 'sing. 1. hilera de hormigas rojas. Cl. 5. 2. hormiguero. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rihúo', 's.', NULL, NULL, NULL, NULL, 'sing. envuelto, paquete, envoltorio. nido. cartucho. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riiba', 's.', NULL, NULL, NULL, NULL, 'sing. rocío. Cl. 5. Tb. rimma, rubba', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riiliiri', 's.', NULL, NULL, NULL, NULL, 'sing. saneamiento. limpieza. Cl. 5. Tb. bOi/iir;', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riín', 's.', NULL, NULL, NULL, NULL, 'sing. anillo, sortija, alianza. Cl. 5 ; e - ri e mareri el an i 110 de boda', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rikaí', 's.', NULL, NULL, NULL, NULL, 'sing. hospital. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikakatyó', 's.', NULL, NULL, NULL, NULL, 'sing. desorden, desconcierto, incer tidumbre. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikakí', 's.', NULL, NULL, NULL, NULL, 'sing. ruina, desperdicio. Cl. 5. Tb. rikappi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rikamiisa', 's.', NULL, NULL, NULL, NULL, 'sing. joven y bella doncella. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikanápette', 's.', NULL, NULL, NULL, NULL, 'sing. 1. masa blanda y pegajosa. 2. gran cantidad de heces blandas. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikappi', 's.', NULL, NULL, NULL, NULL, 'sing. destrucción, destrozo, ruina, etc. despilfarro, derroche. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikará', 's.', NULL, NULL, NULL, NULL, 'sing. lugar de blancos, de extranjeros. Cl. 5 ; o luarí lua - el conti nente de los blancos, Europa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikatte', 's.', NULL, NULL, NULL, NULL, 'sing. lugar donde duermen los murcié lagos. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikatto', 's.', NULL, NULL, NULL, NULL, 'sing. contador. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikatto', 's.', NULL, NULL, NULL, NULL, 'sing. vaso, cubiletc. Cl. 5. Tb. tompulla', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rike''o', 's.', NULL, NULL, NULL, NULL, 'sing. prueba, ensayo. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikekko', 's.', NULL, NULL, NULL, NULL, 'sing. mejilla, mofletc. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikélékélée', 's.', NULL, NULL, NULL, NULL, 'sing. animación, diversión, parranda. jolgorio, juerga. Cl. 5 ; e - ri o motóo wela la juerga que hay en el coche, la animación del coche. rikelessi, pret. v. o rikella ; o buatébi sapá a - o obulaella el juez calumniaba al abogado. rikeUa, v. calmnniar; o la - e materi tú calumnias a la monja. Pret. rike ri. rikelessi. rikeri, pret. v. o rikella ; to bo - o obulaella nosotros calumniamos al abogado. rikessi, pret. v. o rikka ; n - kóri n ta aan be''a me hundía porque no sé nadar. rikessi, pret. v. o rikkáa ; e sotyáa si - o lobbo 10 bobeIle lÍl el soldado torcía el brazo de mi hermano', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikettá', 's.', NULL, NULL, NULL, NULL, 'sing. caimán, cocodrilo. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riketyí', 's.', NULL, NULL, NULL, NULL, 'sing. crustáceo ermitaño. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('rikibba', 's.', NULL, NULL, NULL, NULL, 'sing. parada. Cl. 5. Tb. riebba', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikikká', 's.', NULL, NULL, NULL, NULL, 'sing. racimo. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikká', 's.', NULL, NULL, NULL, NULL, 'sing. cola del gallo. Cl. 5. rikka, v. hundirse; na botyo a ta aan be''a a la - si una persona no sabe nadar se hunde. Pret. rikki, rikessi. rikkáa, v. torcer, retorcer, doblar; e húbbé e lá - e hNko e somíoko el ladrón tuerce el cuello del gallo. Pret. rikkíi, rikessi. 280 / rikki rikki, pret. v. o rikka ; o botyo a -la e emmommo la per sona se hundió con el tronco', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikkí', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. cerco, valla. parque, cercado. Cl. 5 ; - rá a bollá parque infantil. rikkíi, pret. v. o rikkáa ; n-o lobM 10 áí yo torcí su brazo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikko', 's.', NULL, NULL, NULL, NULL, 'sing. tenedor. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rikobbe', 's.', NULL, NULL, NULL, NULL, 'sing. planta del plátano macho, plata nero. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikobinna', 's.', NULL, NULL, NULL, NULL, 'sing. jefatura. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikokko', 's.', NULL, NULL, NULL, NULL, 'sing. temblor, ataque de nervios. cohesión, unión. Cl. 5. Tb. rityíbierí (pl. batyíbierlJ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikokko', 's.', NULL, NULL, 'Cl. 5', NULL, 'sing. alumbrado, iluminación. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikokoo', 's.', NULL, NULL, NULL, NULL, 'sing. cohesión, solidaridad. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikokottó', 's.', NULL, NULL, 'Cl. 5', NULL, 'sing. calambre. absceso duro. . Tb. rihíhi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikookonno', 'adj.', NULL, NULL, NULL, NULL, 'pequeño, pequeña, corto, corta, etc. Concuerda con las palabras de la Cl. 5. Cfr. rikookoo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikookoo', 'adj.', NULL, NULL, NULL, NULL, 'pequeño, pequeña, corto, corta, etc. Concuerda con las palabras de la Cl. 5; rikobbe plátano pequeño, riallá - mano pequeña. rikora, v. denunciar, acusar, delatar; o botyo á e eriia a la - a batyo el paisano denuncia a la gente. Pret. riko riia, rikoresiia. rikoresüa, pret. v. o rikora ; n yo denunciaba, o - tú denunciabas, a - él denuncia ba, tii - nosotros denuncíábamos, 10 - vosotros d enunciabais, ba - ellos denuncíaban. rikoriia, pret. v. o rikora ; n-o biibbe lÍl kóri a le óppi denuncié a mi esposo porque me pegó. R', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikotánta', 's.', NULL, NULL, NULL, NULL, 'sing. contenedor de papeles. papelera. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikottí', 's.', NULL, NULL, NULL, NULL, 'sing. *pañal. Cl. 5. Ej. exp r. e sine''e si aríi - el bebé lleva un pañal', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikotto', 's.', NULL, NULL, NULL, NULL, 'sing. pie, patada. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikottó', 's.', NULL, NULL, NULL, NULL, 'sing. puño, puñetazo. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikótto', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. colección, conjunto. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikottoáta', 's.', NULL, NULL, NULL, NULL, 'sing. planta del pie. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikotye', 's.', NULL, NULL, 'Cl. 5', NULL, 'sing. tren. camión largo, camión en general. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rikuku', 's.', NULL, NULL, NULL, NULL, 'sing. tajada. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rilabba', 's.', NULL, NULL, NULL, NULL, 'sing. lugar para tratar varios asun tos. política. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rilé', 'adj.', NULL, NULL, NULL, NULL, 'dem. aquel, aquella. Concuerda con las palabras de la Cl. 5; - isaké aquel machete, raatyé aquella cama', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('rile''é', 's.', NULL, NULL, NULL, NULL, 'sing. hernia, prostatitis. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rile''o', 's.', NULL, NULL, 'Cl. 4', NULL, 'sing. 1. nombre de Basakato del Este. 2. depósito, almacén. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rilebueri', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. observación, atención. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rilekku', 's.', NULL, NULL, NULL, NULL, 'sing. escondite, lugar donde se puede ocultar algo. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rileppo', 's.', NULL, NULL, NULL, NULL, 'sing. refugio, retiro, depósito. Cl. 5. rílessi, pret. v. o ''rílla ; o mmo a - e tyóbbo lÍl el demonio exterminaba mi hogar. rílla, v. exterminar, matar; na mmo a la - e tyób bo lÍl ká mmo obbé si un demonio extermina mi hogar es porque es un demonio malo. Pret. ríríi, rílessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('ríoo', 'S.', NULL, NULL, 'Cl. 6', NULL, 'sing. fogón. fuego de tres piedras. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rioppí', 'S.', NULL, NULL, NULL, NULL, 'sing. castigo, punición. Cl. 5. 282 / rioppo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('ripanná', 's.', NULL, NULL, NULL, NULL, 'sing. España. Cl. 5. Tb. ripaasí, ripanyá', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('rityo', 's.', NULL, NULL, NULL, NULL, 'sing. sociedad. Cl. 5; ii - la socie dad, la vida', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rityué', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. pescaderia. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riukí', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. confusión. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('riuppoo', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. cuesta, montaña. Cl. 5 ; - rito una montaña alta', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('roáa', 's.', NULL, NULL, NULL, NULL, 'sing. hacha, mango. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('roberi', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. pagaduría, cobro. Cl. 5. Tb. rioberi', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('robetyoru', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. camero. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('rokalla', 's.', NULL, NULL, 'Cl. 6', NULL, 'sing. unión, unidad. Cl. 5. Tb. rokka', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rokáteri', 's.', NULL, NULL, 'Cl. 5', NULL, 'sing. comienzo, inicio. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('rokátya', 's.', NULL, NULL, NULL, NULL, 'sing. avanzadilla, precursor. Cl. 5', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('saláa', 's.', NULL, NULL, NULL, NULL, 'sing. cáscara del palmiste. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sámoóte', 's.', NULL, NULL, NULL, NULL, 'sing. mes de febrero. Cl. 12. Sancola, antrop. que parece obtenerse a partir de los términos Sáám y cola. Se localiza en Bahó', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sanná', 's.', NULL, NULL, NULL, NULL, 'sing. dedo anular. Cl. 12; e - el dedo anular', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('sappé', 's.', NULL, NULL, NULL, NULL, 'sing. hollejo seco de poca cantidad. Cl. 12. sappi, pret. v. o sappa ; o obitya bo - e oonessú lÍl el ratón mordisqueó mis dedos del pie', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sáppo', 's.', NULL, NULL, NULL, NULL, 'sing. tienda, abacería, comercio. Cl. 12. . sára, v. atemorizar, intimidar; e erikiriki e lá - a batyo la sombra atemoriza a la gente. Pret. sáría, saresiia. saresiia, pret. v. o sára ; e enokonokko e - a bOllá el ogro atemorizaba a los niños', NULL, 'roter', 'Fuente: bubi-español', 'import-script'),
 ...
 ('sarí', 's.', NULL, NULL, NULL, NULL, 'sing. mujercita, esposita. Cl. 12. sáría, pret. v. o sára ; e eno konokko e le - el ogro me atemorizó. sáríi, pret. v. o salláa ; n bo - 010 botyo tuve miedo de esta persona', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sarÍolla', 's.', NULL, NULL, NULL, NULL, 'sing. ancianita, viejecita. Cl. 12. Tb. sarítyityi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sarítyityi', 's.', NULL, NULL, NULL, NULL, 'sing. ancianita con mucha expe riencia, viejecita. Cl. 12. Tb. saríolla', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sataté', 's.', NULL, NULL, NULL, NULL, 'sing. tiesto. cuenco. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('satée', 's.', NULL, NULL, NULL, NULL, 'sing. ladito, trocito. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sátiré', 's.', NULL, NULL, NULL, NULL, 'sing. sábado. Cl. 12. Tb. lokia. Sautó, anlrop. que debería escribirse Santo''o. Se localiza en Rebola', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sauto''o', 's.', NULL, NULL, NULL, NULL, 'sing. frasco, petaca. Cl. 12. Tb. sitó ''o, tamma. se''a, v. medir, alinear; n tori o - e biyári o tengo que medir tus parcelas. Prel. se''i, se''essi. se''essi, pret. v. o se''a ; n bi - e biyári o yo los medía, tus parcelas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('se''i', 's.', NULL, NULL, NULL, NULL, 'sing. 1. barro rojo 2. límite. Cl. 12. se''i, pret. v. o se''a ; la bOlo botté 10 - o bokOo con este palo medisteis la calle', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('se''o', 's.', NULL, NULL, NULL, NULL, 'pl. 1. mediciones. 2. balanzas, balances, pesas. Cl. 10. se''úbbi, pret. v. o se''úbba ; o -la o lOé gemiste con el lloro. se''úbba, v. gemir, sollozar; n la ó''a botyo ná a la - oigo a alguien que solloza. Pret. se''úbbi, se''úbessi. se''úbessi, pret. v. o se''úbba ; o wanapana a - kóri a tyí''a hetyíi el estudiante solloza ba porque no aprobó. 290 / sebaam sebaam, pret. v. o seballa ; n-a batyo ba orii bo bá soñé con las personas que fueron asesinadas', NULL, 'o rutya', 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('si''obbá', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. navaja. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('si''otya', 'adj.', NULL, NULL, 'Cl. 12', NULL, 'sing. primero, primera. . Concuerda con las palabras de la Cl. 12: e sipotto -la primera pimienta negra', NULL, 'siotya', 'Fuente: bubi-español', 'import-script'),
 ('si''ú', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. fuerza, vigor, salud. Cl. 12 ; ká we le? ne - ¿cómo estás? estoy un poco bien', NULL, 'sito''ú', 'Fuente: bubi-español', 'import-script'),
 ...
 ('siakki', 's.', NULL, NULL, NULL, NULL, 'sing. liendre. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sibaella', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. humildad. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sibáka', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. tabaco, rapé. Cl. 12. Sicaya / 293', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('sibekabékka', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. tortolito, palomita. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sibekúbeku', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. barbilla. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sibó', 's.', NULL, NULL, NULL, NULL, 'sing. mirada, miramiento; o mpá -tener en cuenta. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sibokko', 's.', NULL, NULL, NULL, NULL, 'sing. pequeña caverna o cavidad de un árbol. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sibókko', 's.', NULL, NULL, NULL, NULL, 'sing. conchita de mar. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sibónó', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. mosqUIto diminuto. Cl. 12', NULL, 'sibOono', 'Fuente: bubi-español', 'import-script'),
 ('sibotósíbotó', 'adj.', NULL, NULL, NULL, NULL, 'blando, tierno. Concuerda con las palabras de la Cl. 12; sebáám - hoja blanda', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sibotyílla', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. apodo, mote. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('siburúm', 's.', NULL, NULL, NULL, NULL, 'sing. escobilla. Cl. 12. Tb. sibetye, siseseele. Sicaya, antrop. diminutivo de bOlea ya, obte nido a partir del verbo o káya. Sikaya se localiza en Baney. 294 / Sicoco Sicoco, antrop. que presenta dos signifi cados en función de su forma escrita. En primer lugar, Sikókó. En segundo lugar, Sikoko. Está localizado en Basuala', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sihakká', 's.', NULL, NULL, NULL, NULL, 'sing. pequeño nudo corredizo. pequeña trampa. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sihÑtó', 's.', NULL, NULL, NULL, NULL, 'sing. la pequeña flor de la planta de la malanga, el capullo. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sihótóttó', 'adj.', NULL, NULL, NULL, NULL, 'blanquito, blanquita. Concuerda con las palabras de la Cl. 12; siseke - tableta blanquita', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sihuenókii', 'adj.', NULL, NULL, NULL, NULL, 'sing. tibio. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sihuhu', 's.', NULL, NULL, 'Cl. 12', NULL, 'sing. cierto tipo de pájaro. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sihúku', 's.', NULL, NULL, NULL, NULL, 'sing. anzuelo. Cl. 12. Tb. si/ohM', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sihutétete', 's.', NULL, NULL, NULL, NULL, 'sing. oruga. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('siítyi', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. dedo meñique. Cl. 12. Sijolari, antrop. que en bubi debería escribirse Sihólári. Se localiza en Moka. Sikachá, antrop. diminutivo de katyá. Sikatyá se localiza en Bahó', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('sikíkko', 's.', NULL, NULL, 'Cl. 12', NULL, 'sing. columpio. . sikkáa, v. adelgazar, perder peso, menguar, mermar, desmedrarse; ii bOllá a la - kóri a tyá la ráa el niño adel gaza porque no come. Pret. sikkí, sikessi. sikkí, pret. v. o sikkáa ; ii - sóté has adelgazado mucho, estás muy delgado. '' sikkiáa, 1. s. sing. cigarrillo, pitillo. Cl. 12. Tb. simíki. 2., v. desmedrar, medrar, disminuir, reducir el tamaño de algo. Pret. sikía, sikiesiia. Silo / 295', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sikullá', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. cantimplora. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('silopelOpe', 'adj.', NULL, NULL, NULL, NULL, 'sing. despistado, desorientado. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('sinkiletti', 's.', NULL, NULL, NULL, NULL, 'sing. camiseta. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sínne', 's.', NULL, NULL, 'Cl. 12', NULL, 'sing. cine, película, local de cine. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sinoke', 's.', NULL, NULL, NULL, NULL, 'sing. crío, criatura, cachorro. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sinooa', 's.', NULL, NULL, 'Cl. 12', NULL, 'sing. culebrita. . Tb. sibappa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sinópi', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. tabaco molido. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sinorí', 's.', NULL, NULL, NULL, NULL, 'sing. pájaro. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sinta', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. hoja, papel. Cl. 12. Tb. sipéppa, sintanta. sin tanta, s. sing. papel, hoja. . Tb. sinta, sipéppa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sintúsíntú', 'adj.', NULL, NULL, NULL, NULL, 'cortito, cortita, bajito, bajita. Concuerda con las palabras de la Cl. 12; e sityo - la personita bajita', NULL, 'siñtú', 'Fuente: bubi-español', 'import-script'),
 ...
 ('siOkollo', 's.', NULL, NULL, NULL, NULL, 'sing. picante, pimienta, guindilla. Cl. 12', NULL, 'sokollo', 'Fuente: bubi-español', 'import-script'),
 ('siokoríbba', 's.', NULL, NULL, NULL, NULL, 'sing. laguna. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('Sioto', 'antrop.', NULL, NULL, 'Cl. 12', NULL, 'obtenido a partir de eoto. SiOtij está localizado en Bahó y en Basupú. siOtya, acij. sing. primero, primera. . Concuerda con las palabras de la Cl. 12: e sipotto - la primera pimienta negra. sipúm / 297', NULL, 'si''otya', 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('sipaao', 's.', NULL, NULL, NULL, NULL, 'sing. pequeña entrada en la sien. Cl. 12. Sipachí, antrop. diminutivo de opatyí. Sipatyí se localiza en Batoicopo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sipalláa', 'S.', NULL, NULL, NULL, NULL, 'sing. canastilla. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sipelló', 'S.', NULL, NULL, NULL, NULL, 'sing. fe stín. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipényápényá', 'S.', NULL, NULL, NULL, NULL, 'sing. pata. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipepáa', 'S.', NULL, NULL, NULL, NULL, 'sing. papel, folio. Cl. 12. Tb. sinta, sipéppa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipepáam', 'S.', NULL, NULL, NULL, NULL, 'sing. verdura gelatinosa. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipepe', 'S.', NULL, NULL, NULL, NULL, 'sing. pipa. falo. Cl. 12. Tb. bOoppá', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sipéppa', 's.', NULL, NULL, NULL, NULL, 'sing. papel, folio. Cl. 12. Tb. sinta, sipepáa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipetye', 'S.', NULL, NULL, NULL, NULL, 'sing. gorrioncito. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sipo''a', 'S.', NULL, NULL, NULL, NULL, 'sing. mono tití, monito. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipókkó', 's.', NULL, NULL, NULL, NULL, 'sing. becerro, novillo. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipollá', 's.', NULL, NULL, NULL, NULL, 'sing. piernecita. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipopotto', 'S.', NULL, NULL, NULL, NULL, 'sing. cuenta menuda, abalorio. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipoppi', 's.', NULL, NULL, NULL, NULL, 'sing. avaricia, tacañería. avaro, tacaño. Cl. 12 ; 010 botyo e - esta persona es avara', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipóríi', 's.', NULL, NULL, NULL, NULL, 'sing. cabrito, cabrita. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('siporóko', 's.', NULL, NULL, NULL, NULL, 'sing. rumor, comentario. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('sipóssi', 'S.', NULL, NULL, NULL, NULL, 'sing. gato, jineta. Cl. 12. Sipoto, an/rop. diminutivo de opotto. Sipotto se refiere a la misma pimienta negra. Se localiza en Baloeri y en Batoicopo', NULL, 'tyippa', 'Fuente: bubi-español', 'import-script'),
 ('sipotto', 's.', NULL, NULL, NULL, NULL, 'sing. pimienta negra del país. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipoya', 'S.', NULL, NULL, NULL, NULL, 'sing. polilla. Cl. 12. sippí, dim. sing. genital femenino pequeño. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipuá', 'S.', NULL, NULL, NULL, NULL, 'sing. perrito, chucho. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sipúm', 'S.', NULL, NULL, NULL, NULL, 'sing. cuchara de cualquier tipo. Cl. 12. Tb. sihá. 298 / sipúrúu', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipúrúu', 's.', NULL, NULL, 'Cl. 12', NULL, 'sing. puertecita. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sipussu', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. diversión, juego. juguete. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sisoppo', 's.', NULL, NULL, NULL, NULL, 'sing. panecillo. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sisorí', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. cordel, hilo. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sisula', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. coscorrón, capón. Cl. 12. Tb. wakóo', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('sitaeta''e', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. hongo. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('siteppe', 's.', NULL, NULL, NULL, NULL, 'sing. tabiquito, pequeña pared, tabique f ino. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sitímma', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. barco, buque, nave, navío. Cl. 12. Tb. buatto', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sito', 'adj.', NULL, NULL, NULL, NULL, 'alto, largo. Concuerda con las palabras de la Cl. 12; siokollo - picante largo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('sitúllu', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. orinal. Cl. 12. Tb. epó', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sityatyapellé', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. bicicleta. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sityóbbo', 's.', NULL, NULL, NULL, NULL, 'sing. casita, caseta. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sityoru', 's.', NULL, NULL, NULL, NULL, 'sing. cordero. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sityotyo', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. ballenato. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sityué', 's.', NULL, NULL, NULL, NULL, 'sing. pescadito. Cl. 12. só, entonces, para ello, etc. so''a, v. htmdirse; o borito bo lá - e eteppe el peso hunde la pared. Pret. so''í, so''essi. so''essi, pret. v. o só''a ; o -la o bOritto o te hundías con tu peso. so''í, 1. pret. v. o só''a ; e tyóbbo e - la casa se hundió. 2. s. sing. y pl. venado. CIs. 9 y 10. sóa, v. 1. coser; n la - e torosíssiÓl yo coso mi pantalón. 2. fijar la mira da en alguien o en algo. Pret. sói, sóessi. soalessi, pret. v. o soalla ; o bOkoé n bo - bisoÍ al bra cero le calumniaba. soalla, v. calumniar; n la - o botyo bisoÍ yo calumnio a alguien. Pret. soari, soalessi. soari, pret. v. o soalla ; 010 botyo to bo - bisoÍ a esta perso na le calumniamos', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('sokolityé', 'adj.', NULL, NULL, NULL, NULL, 'sing. célebre, famoso. Cl. 12. sokolla, v. 1. desabrochar; o la - e sotte o tú desabrochas tu camisa. 2. for nicar. Pret. sokori, sokolessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sollá', 's.', NULL, NULL, NULL, NULL, 'sing. niñito, muchachito. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sollé', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. cosita, algo. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sollo', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. sal. . solobbia, v. salar; 10 la - i tyué vosotros saláis el pescado. Pret. solobiia, solobiesiia. solobiesiia, pret. v. o solobbia ; tue - e nabba nosotros salábamos la carne. solobiia, pret. v. o sOlobbia ; o bolÍlrnua lo bo la carne lo salasteis', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sOlólló', 'adj.', NULL, NULL, NULL, NULL, 'sing. viejo, viejito, veteranito. Concuer da con las palabras de la Cl. 12; e siatta - el cuento viejo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('sukáa', 'S.', NULL, 'sing.', NULL, NULL, 'y pl. azúcar. els. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('sukku', 'S.', NULL, NULL, NULL, NULL, 'sing. pequeña selva. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('súllée', 'S.', NULL, NULL, NULL, NULL, 'sing. tortuga de bosque. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('sulufáto', 'S.', NULL, NULL, NULL, NULL, 'sing. sulfato, insumo. Cl. 12', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('tekka', 's.', NULL, NULL, NULL, NULL, 'pl. rafia. Cl. 10. tekka, v. hacer cosquillas; n la - o buityíi lÍl hago cosquillas a mi herma nito. Pret. tekki, tekessi. Tb. o bukka. tekki, pret. v. o tekka ; n bo - o buityíi lÍl hice cosquillas a mi hermanito', NULL, 'bukki', 'Fuente: bubi-español', 'import-script'),
 ('telállo', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. entradas, puertas. els. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('teleri', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. hilos para coser, para trenzar, etc. els. 9 y 10. Tb. sisorí', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('telle', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. caminos, senderos, itinerarios, pasos, derroteros, destinos. els. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('telo', 's.', NULL, NULL, NULL, NULL, 'sing. dedo corazón. Cl. 9', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('teppo', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. nivel, grado. els. 9 y 10. tételessi, pret. v. o tétella ; o bonánna a - i kollo la abuela debilitaba a las sardinas por medio de una sustan cia vegetal. tétella, v. debilitar por medio de alguna sustancia vegetal o química atraer por medio de cualesquiera argucias con objeto de despistar o desorientar a una persona o a un animal. Pret. téteri, tételessi. téteri, pret. v. o tétella ; i kollo to i nosotros debilitamos las sardinas. tétessi, pret. v. o tétta ; o liibinno lo - e bimpa la apiso nadora tritura las piedras. Pret. tétyi, tétessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tetto', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. glandes, cabezas del penes. els. 9 y 10. tetya, 1. s. sing. y pl. color, colores. els. 9 y 10 ; e - killó el color negro, e - tolla el color rojo o granatc, e - obo el color ocre, e - peppa color gris. 2. -, v. dibujar, colorear, pintar; n la - yo dibujo. Pret. tetyi, te tyessi. Tb. o dibuhalla. tetya, v. imponer, condecorar; o la - esokka tú impones una medalla. Pret. tetyía., te tyesiia. tetyesiia, pret. v. o tetya ; e kobinna a - a batyo ba mmaa bá''a buéi ba e ebéló e ko''e el gobierno condecoraba a todas las personas que murieron en tiempos del gallo. tetyessi, pret. v. o tetya ; a bokútta ba pi''o los médicos dibu jaban riñones. tetyi, pret. v. o tetya ; o bue''iáa a - i nab ba kubbaa i é eriia wela el maestro dibujó todos los animales del pueblo. tétyi, pret. v. o tétta ; e emasíín e - a bate la máquina trituró las piedras. tetyía, pret. v. o tetya ; o botúkku bote a - a abitábítta el gran jefe condecoró a los militares', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('teute''u', 's.', NULL, NULL, NULL, NULL, 'pl. pombas grandes. espumas. Cl. 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tiríti', 's.', NULL, NULL, NULL, NULL, 'sing. calle, callejuela. Cl. 9. Tb. bo ''o, bokoo. toallo / 311 to, mor:l l. prf4l sujo nosotros, nos; mpári - bíles si ayer bailábamos. 2. moif. conc. ellos, ellas; tonori - ba pájaros ellos dos. 3. s. pl. plantas del ñame. Cl. JO ; o óppa ¡- pegar las plantas del ñame. to, 1. mOTi num. cinco. Debe llevar el morfema con cordante de la Clase del nombre determinante. Cls. 2 y 6: batyo/abósekka ba - personas/acor deones cinco. Cl. 4: besuppa be - trenzas cinco. Cl. 8: bihótto bi - horas cinco. Cl. JO: kallo -/tyo rodetes cinco. Cl. 13: toatta to - historietas/cuentos cinco. 2. adj. largo, alto. Concuerda con las pala bras de las Cls. 9 y 10; e tyóbbo - casa alta, i tyób bo - casas altas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tó', 'adj.', NULL, NULL, NULL, NULL, 'num. diez; toatta tué - diez cuentos. Con cuerda con las palabras de la Cl. 13. tó''a, v. 1. vencer, ganar, derrotar; a batyo ba lá - i pókkó la gente ven ce a los bueyes. 2. sacar la comida; o bOie IÍl a la - o bora''o mi padre saca la comida. Pret. tó''i, tó''essi. tó''e, int. ¡basta!, ¡ya vale!, ¡cálmate! tó''elessi, pret. v. o tó''ella ; o bolappí a - a batyo ba mmaa el cocinero sacaba la comida para toda la gente. tó'' ella, v. sacar la comida para alguien; o boie a la - a bollá el hombre saca la comida para los niños. Pret. tó''eri, tó''e lessi. tó''eri, pret. v. o tó''ella ; o bOie a ba - a bOllá el hombre sacó la comida para los niños. tó''essi, pret. v. o tó''a ; a ba tó''i pókkó ba - e bittá los que vencieron los bue yes ganaban la guerra. tó''i, pret. v, o tó''a ; lo - o bora''o sacasteis la comi da, lo - e bitta ganasteis la guerra. tó''ía, pret. v. o tó''ia ; o bOtyo a e eriia a le - el paisano me sacó de dudas. tó''ia, v. 1. explicar, sacar de dudas; o bue''iáa a la - a bakuerakueráa el maestr', NULL, 'o wínanna', 'Fuente: bubi-español', 'import-script'),
 ('to''obbá', 's.', NULL, NULL, NULL, NULL, 'pl. navajas. Cl. 13. Tb. tuettáa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('to''óleri', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. portavoz. charlatán, parlanchín. Cls. 9 y lO. to''ólla, v. hablar, dialogar, conversar, opinar, parlar; to la - e etyo nosotros hablamos el bubi, a bollá ba lello ba ta aan o e etyo los niños de hoy no saben hablar el bubi. Pret. to''óm, towessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tó''ólló', 's.', NULL, NULL, NULL, NULL, 'pl. lenguas, idiomas, hablas. Cl. 13. to''óm, pret. v. o to''ólla ; mpári 10 - e etyo ayer hablasteis el bubi. tó''óra, v. interpelar; o buatébisapá a la - e kobinna el juez interpela al gobierno. Pret. tó'' óriia, tó''óresiia. tó''óresiia, pret. v. o tó''óra ; o bu até bisapá a - e eriia el juez interpelaba al pueblo. tó''óriia, pret. v. o tó''óra ; o buatébi sapá a - e eriia el juez interpeló al pueblo. to''otya, aqj. pl. primeros, primeras. Cl. 13. Concuerda con las palabras de la Cl. 13; o topotto - las primeras pimientas negras. to''ú, 1. s. sing. facultad, autorización, energía, fuerzas, vigor, beneplácito, potestad, potente. Cl. 13 ; -la ri''uá a ta bá pala'' e la fuerza y la suerte son incompatibles. 2. ad). dificil; e ehMmero é - la res puesta es dificil. toáán, pret. v. o toánna ; e bilabba bi los hechos están mezclados', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toakki', 's.', NULL, NULL, NULL, NULL, 'pl. liendres, piojos pequeños. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toallo', 's.', NULL, NULL, NULL, NULL, 'pl. pequeñas manifestaciones artísticas con baile, canto, etc. Cl. 13. 312 I toánessi toánessi, pret. v. o toánna ; n la - a lokko la mmaa yo mezclaba todas las cosas. toánna, v. mezclar; ii waíssii a la - ii túp pu tii e ripelló Ia mujer mezcla las salsas de la fiesta. barajar. Pret. toáán, toánessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toatta', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cuentos, historietas, fábulas. . Tobachi, antrop. obtcnido a partir de tjjbatyibatyi. Tiibatyi está localizado en Basakato de la Sagrada Familia y en Basuala', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobaella', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. humildades. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobáka', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. tabacos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobakka', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. urnas, cajitas. . tobálelessi, pret. v. o tobálera ; a ba seseppe ba - i siityáa los jóvenes desafiaban a los soldados. tobálera, v. desafiar; n la - a batyii yo desafio a las personas. Pret. tobále ri, tobálelessi. tobáleri, pret. v. o tobálera ; n ba - a batyii yo desafié a las per sonas. tóbalessi, pret. v. o tóballa ; e biulla be - a baebba las doncellas se encontraban con los vinateros. tóballa, v. encontrarse con alguien o con algo; na biityii a la - kiittó tii''a ká tóbalakiittó si alguien se encuentra con un valiente decimos que se llama encontrador de valiente. Pret. tóbari, tóba lessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobappa', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. culebritas, serpientes pequeñas. . Tb. lonooa. tóbari, pret. v. o tóballa ; ne le pooe n-e rioppo cuando llegué me encontré con la batalla', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tobatya', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. varitas, flechitas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobatyabatya', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. costillas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobatyibatyi', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. primeras hierbas después de desbrozar un terreno. . tobba, v. derramar; n la - a biitá yo derramo el aceite. Pret. tobbi, tobessi. tobba, v. herirse, lastimarse; ii biiseseppe a paa''e o - e esókkó wela el joven puede lastimarse en su juventud. Pret. tóbbi, tóbessi. tóbba, v. acudir; n la - acudo, we tóbbe no acudas. Pret. tóbbi, tóbessi. tóbbáa, v. defecar, cagar; ii la ba - o tú defecas, ii tyá ba - o tú no defecas. Pret. tóbbíi, tóbessi', NULL, 'o hella', 'Fuente: bubi-español', 'import-script'),
 ('tobbe', 'adj.', NULL, NULL, 'Cl. 13', NULL, 'pl. machitos, varoncitos. Concuerda con las palabras de la ; ii tollá - los muchachitos varones. tobbi, pret. v. o tobba ; n-a biitá, n ba - a biitá, derramé el aceite. tobbi, pret. v. o tóbba ; e rikotto ri áí ri - su pie se lastimó. tóbbi, pret. v. o tóbba ; n e - mpári acudí ayer. tobbia, v. lastimar a alguien, lisiar; n la 0- te lastimo, te voy a lastimar. Pret. tóbía, tóbiesiia. tóbbíi, pret. v. o tóbbáa ; n ba - o yo defequé, n ta ba - o no defequé', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobbo', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. y pl. heridas, cortes, lesiones. armas. Cls. 9 y 10. tobbó, 1. S. pl. miradas, miramientos; o mpá tener en cuenta. . 2. adj. pl. duros, fuertes. Concuerda con las palabras de la ; ii tollá - los mucha chitos fuertes', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tóbboo', 'S.', NULL, NULL, 'Cl. 10', NULL, 'pl. mandamientos, recados, envíos. mensajes. ', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('tobekabékka', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. tortolitos, palomitas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobekúbeku', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. barbillas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobelle', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. mamitas, tetinas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobélló', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. momentitos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobelo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. antílopes. . Tb. tuetyi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobelOhékka', 's.', NULL, NULL, NULL, NULL, 'pl. instantes, momentos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobeolla', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. ancianitos, viejecitos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toberí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. nanas, romanzas. . tobesei, pret. v. o tobea. tobessi, pret. v. o tobba ; n-a biitá, n ba - a biitá, yo derramaba el aceite. tobessi, pret. v. o tóbba ; to la i kobbá nos lastimábamos con los cuchillos. tóbessi, 1. pret. v. o tóbbáa ; n ba - o yo defecaba, n ta ba - o yo no defecaba. 2. pret. v. o tóbba ; o - tú acudías', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobetté', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. barricas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobétto', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. pequeños ritos de la reconciliación. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobetye', 's.', NULL, NULL, NULL, NULL, 'pl. escobillas. Cl. 13. Tb. tiiburúm, tiisesee le', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobetyityi', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. bisabuelos. . tobía, pret. v. o tóbbia ; ba - o bOtyelemán lastimaron al preso. tobieseei, pret. v. o tobeea ; o motóo bo - el coche se volcaba. tobiesiia, prel. v. o tóbbia ; e eaó e le - el hacha me lasti maba, o - o BOsoppé tú las timabas a B6soppé', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tobinna', 's.', NULL, NULL, NULL, NULL, 'pl. mocos, mucosidad. gripe. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobitya', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. ratoncitos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobokko', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. pequeñas cavernas o cavidades de un árbol. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobókko', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. conchitas de mar. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tobólló', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. pobres, desvalidos, paupérrimos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobónó', 's.', NULL, NULL, NULL, NULL, 'pl. mosquitos. Cl. 13. tobóri, pret. v. o tobólla ; n la a lokko la áno separé vuestras cosas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobotóobbó', 's.', NULL, NULL, NULL, NULL, 'pl. aguardiente, bebida alcohóli ca. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobotótóbotó', 'adj.', NULL, NULL, NULL, NULL, 'blandos, tiernos. Concuerda con las palabras de la Cl. 13; tohá - cucharas blandas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tobotyera', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. cariños, ternuras. piropos. Cl. 13. tobuessi, pret. v. o tob611a ; a batyo bo o rótta ba - i tyué las personas del mercado esco gían el pescado', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('tobúkku', 's.', NULL, NULL, NULL, NULL, 'pl. 1. libritos. 2. papeles. 3. oficios. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toburúm', 's.', NULL, NULL, NULL, NULL, 'pl. escobillas. Cl. 13. Tb. tiibetye, tiiseseele. Tocolo, antrop. también escrito Tokolo. Debería escribirse Tookollo. Está localizado en Basakato de la Sagrada Familia. toen na, s. pl. ardillas pequeñas. Cl. 13. 314/ toeppa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toeppa', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. hojas de lija, lijas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toesse', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. collarines. collarines con cam panillas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toette', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. palitos para cavar, picos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tohá', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cucharas. . Tb. topúm. tohakká, . 1''. pl. pequeños nudos corredizos. pequeñas trampas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tohám', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. parecidos, semejanzas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tohe', 'adj.', NULL, NULL, 'Cl. 13', NULL, 'nuevecitos, nuevecitas. Concuerda con las palabras de la Cl. 13; tohúku - anzuelos nue vecitos. toheká, . 1''. pl. trocitos. . Toherida, antrop. obtenido a partir de la f rase to ''á e rUda. To''ériída está localizado en Batete', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tohíri', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. danzas tradicionales comunes. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tohNtó', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. las flores de la planta de la malanga, los capullos. . Tohori, antrop. que debería escribirse Too hóri. Se localiza en Moka', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tohuenóko', 'adj.', NULL, NULL, NULL, NULL, 'pl. tibios. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tohuhu', 's.', NULL, NULL, NULL, NULL, 'pl. ciertos tipos de pájaros. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tohúku', 's.', NULL, NULL, NULL, NULL, 'pl. anzuelos. Cl. 13. Tb. tolobM', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tohutétete', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. orugas. Cl. 13. Toichoa, antrop. que debería escribirse To''ítyo''áa o también To''ityooa. Está localizado en Basakato de la Sagrada Fa milia', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toilalokó', 's.', NULL, NULL, NULL, NULL, 'pl. plantas perennes. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('tokko', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. clavo, punta, gancho. Cls. 9 y 10', NULL, 'néri', 'Fuente: bubi-español', 'import-script'),
 ('toko''e', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pollitos, gallinitas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toko''ó', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. hierbas limón, citronelas. . Th. kontrití', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tokokkí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cigüeñas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokokoo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pequeñas cohesiones. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokolityé', 'adj.', NULL, NULL, 'Cl. 13', NULL, 'pl. célebres, famosos. . tokólla, v. extirpar, arrancar; a basesepari ba lá - i tyetyélle las muchachas extirpan la carne de los moluscos univalvos. Pret. tokóri, tokuessi. tOkólla, v. 1. desengarzar, desensartar, deste jer. 2. o - biilláa pacificar, arreglar el problema de dos contendientes. Pret. tokóri, tokuessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokollé', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cositas, objetitos. . Tokolo, an/rop. también escrito Toco10. Tiiiikiillii está localizado en Belebú. tokóm, pret. v. o tokólla ; n bii - ii biilláa bii a bá lo batyii arreglé el proble ma de estas dos personas', NULL, 'tokóri', 'Fuente: bubi-español', 'import-script'),
 ('tokono', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pequeños, diminutos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokookonno', 'adj.', NULL, NULL, 'Cl. 13', NULL, 'pequeños, pequeñas. Concuer da con las palabras de la ; tiinki la tiinorí - moscas y pájaros pequeños. tokookoo, 1. s. pl. cosas o personas pequeñas y delgadas. . 2. adj. pequeños, pequeñas. Concuerda con las palabras de la Cl. 13; tiityii - personitas pequeñi tas. Tb. tokookonno', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokoppo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. botes, latas. . tokóri, pret. v. o tokólla ; e sipóssi si - e nokko a ii iibitya el gato arrancó el oj o del ratón. tokóri, pre/. v. o tokólla ; ii be - e betiittii tú desengarzaste las cuentas. Th. tokóm', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokorokko', 's.', NULL, NULL, NULL, NULL, 'pl. poca cantidad de bebida alcohó lica. Cl. 13. Tokotobe, an/rop. compuesto por tokko y /abé. Debería escribirse Tokkotiibé. Se localiza en Bocoricho', NULL, 'tua ''u', 'Fuente: bubi-español', 'import-script'),
 ('tokótta', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. objetos o personas que agrupan o reúnen. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokottí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. *compresas, támpax. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokotye', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. camionetas, furgonetas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokuella', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. escuelas, colegios. . tokuessi, pret. v. o tokólla ; ii biibelle lÍ1 a - e biliillá mi hermano arrancaba la carne de las conchas marinas. tokuessi, pret. v. o tokólla ; a batyii bololló ba - i tyerú las personas mayores desengarzaban las nipas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tokullá', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. cantimploras. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokutúm', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. chabolas, ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tokuua', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. dirn. de telas, paños. bande rines. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tOlabba', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. ej emplos, cositas, asuntillos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toláe', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. niños, muchachitos, chiquillos, nenes. . tolaelessi, pret. v. o tolaella ; to ta bí - e bilabba bí obotyo la o mmo no enlazá bamos las cosas de la vida y el Más Allá. tolaella, v. añadir, enlazar, engarzar, entrelazar; to la - e bilabba nosotros enzalamos los asuntos. Pret. tolaeri, tolaelessi. tolaeri, pret. v. o tolaella ; ne e tereri yo enlacé el hilo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tOlappa', 's.', NULL, NULL, NULL, NULL, 'pl. pinzas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tOláppo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. lamparillas, candiles. ; e ripotto wela ri tyi - en la ciudad no hay luz', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tOlé', 'adj.', NULL, NULL, NULL, NULL, 'ciern. aquellos, aquellas. Concuerda con los nombres de la Cl. 13; - toko''ó aquellas citronelas, - tolebbó aque llas campanillas', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('tOlebbó', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. campanillas, cencerros, cencerros pequeños, timbres. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toleppa', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. verduras un poco amargas. Cl. 13. toJessi, pret. v. o tolla ; n - i pillá yo molía los dátiles. tolla, 1. s. pl. masa rojiza que se obtiene de las hojas del árbol botolJa. Se usa para untado en el cuerpo de las jóvenes casaderas. Cl. 10. 2., v. moler los dátiles para separar la fibra de la semilla o hueso. tener que. Pret. tori, tolessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tollá', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. niñitos, muchachitos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tollé', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. cositas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tollo', 's.', NULL, NULL, NULL, NULL, 'pl. sueño, ensueño. Cl. 13; o bonánna e la abuela duerme; - tuá tyommaa sueño eterno, descanso eterno', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tOlobarí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. mejorías. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tOlobbo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. anzuelos. . Tb. tohúku', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tOlólló', 'adj.', NULL, NULL, NULL, NULL, 'pl. viejos, veteranos. Concuerda con las palabras de la Cl. 13; o toatta - las viejas his toríetas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tolOpelOpe', 'adj.', NULL, NULL, 'Cl. 13', NULL, 'sing. despistados, desorientados. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tolOppo', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. pájaros mosca. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomaityi', 's.', NULL, NULL, 'Cl. 13', NULL, 'sing. mes de septiembre. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tOmaraéa', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. escapularios. Cl. 13. Tomasiché, antrop. obtenido a partir de la frase tówási i tyé. Debería escribirse Tówásityé. Se localiza en Bahó', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomeóti', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cementos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomeressi', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. medicamentos, píldoras, gra geas. . Tb. tuak ká', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tomíki', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cigarrillos. . Tb. tokkiáa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomíkoró', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pellizcos. . Tb. tobíkinnó', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomíOko', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. gallos. . Tb. beteo''e', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomma', 'adj.', NULL, NULL, NULL, NULL, 'indo algunos, algunas. Concuerda con las palabras de la Cl. 13; he - tonki hay algunas moscas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomó', 'adj.', NULL, NULL, 'Cl. 13', NULL, 'pl. fuertes, valientes. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomólekke', 'S.', NULL, NULL, NULL, NULL, 'sing. y pl. luciérnaga/s. Cls. 9 y \O', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tomotóo', 'S.', NULL, NULL, 'Cl. 12', NULL, 'pl. cochecitos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tompa', 'S.', NULL, NULL, 'Cl. 13', NULL, 'pl. asientos, escaños, banquetas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonáénáé', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. llovizna', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('tone''e', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. bebés. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonekká', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. manantiales, fuentes. . Tb. torekluí', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonki', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. moscas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonkileti', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. camisetas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonoke', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. críos, criaturas, cachorros. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonooa', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. culebritas, serpientes pequeñas. . Tb. tobappa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonópi', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. tabaco molido, rapé. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonorí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pájaros. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tonta', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. hojas, papeles. . Tb. tiipéppa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tontanta', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. papeles, hojas. . Tb. tonta', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tooa', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. risa. ; o oooa - reirse', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toobbo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. rocas arcillosas sagradas de color ocre. hollines. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tookollo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. picantes, pimientas, guindillas, . Tb. toko//o', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tookoríbba', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. lagunas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toOlÍl', 's.', NULL, NULL, NULL, NULL, 'pl. excrementos, heces, boñigas, cagarru ta. Cl. 13. toóm, pret. v. o to'' ólla ; o - a labba dijiste las cosas', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tooppa', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. *compresas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toosso', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. tabas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tootottya', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. sensitivas o hierbas de matas espinosas y hojas bipinnadas que se cie r r a n al contacto. . topáa, v. atar, ligar ; to la - e póríi atamos la cabra. Pret. topíi, topéssi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topaao', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. entradas en la sien. . topálessi, pret. v. o topálla ; e biho''o ID o bi - ebellá mis postes los ataba con lianas espinosas. topálla, v. atar con; e pókkó to le - lOtyókko el buey lo atamos con cadena. Pret. topám, ilipálessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topalláa', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. canastillas. Cl. 13. topám, pret. v. o topálla ; a abúkku o ba - opetté los libros los até con cuerda', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('topappá', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. aletas, alitas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topatyípatyí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pequeños saltamontes. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('topelapella', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. llamitas. Cl. 13. topelessi, pret. v. o topella ; belo bekobbe o be - o botyo ID estos plátanos los ataba para mi pariente. topella, v. atar para alguien; o bOie m a la le - e pórli mi padre me ata la cabra. Pret. topém, topé''em', NULL, 'tope''em', 'Fuente: bubi-español', 'import-script'),
 ('topelló', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. fe stines. . topem, pret. v. o topélla ; o - e pórli o bOtyo a ripotto até la cabra para la persona de la ciudad', NULL, 'toperi', 'Fuente: bubi-español', 'import-script'),
 ('topénaera', 's.', NULL, NULL, NULL, NULL, 'pl. hechos pequeños. Cl. 13. Ej. expr. i pohá í lé o - las acciones están en los pequeños hechos', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topényápényá', 's.', NULL, NULL, NULL, NULL, 'pl. patas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topepáam', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. verduras gelatinosas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topepe', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pipas. falos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('topetye', 's.', NULL, NULL, NULL, NULL, 'pl. gorrioncitos. Cl. 1 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topiánna', 's.', NULL, NULL, NULL, NULL, 'pl. ovarios. Clases 9 y 10. topíi, pret. v. o topáa ; lo - i kóóIÍl atasteis los leños', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topo''a', 's.', NULL, NULL, NULL, NULL, 'pl. monos titis, monitos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topókkó', 's.', NULL, NULL, NULL, NULL, 'pl. becerros, novillos. Cl. 1 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('topollá', 's.', NULL, NULL, NULL, NULL, 'pl. piernecitas. Cl. 13. topólla, v. desatar, desencadenar; to la - a batyo bá''a tóppi bo bá desatamos a las personas que fueron atadas. Pret. topóm, topuessi. topóm, pret. v. o topóJla ; lo - a batyo ba mmaa desatasteis a todas las personas', NULL, 'tiipóri', 'Fuente: bubi-español', 'import-script'),
 ('topopotto', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cuentas menudas, abalorios. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topoppi', 'adj.', NULL, NULL, 'Cl. 13', NULL, 'pl. avaricias, tacañerías. ava ros, tacaños. . topóri, pret. v. o topólla ; ba - a batyo ba mmaa desataron a todas las personas. Tb. tiipórn', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topóríi', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cabritos, cabritas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toporóko', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. rumores, comentarios. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topóssi', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. gatos, jinetas. . Tb. tyippa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topotto', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pimientas negras del país. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topoya', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. polillas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toppá', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. nubes. . 2 dolorcitos, pequeñas enfermedades. . tóppa, v. atar, liar; to la - o botyo eIÍlmetyi o atamos a la persona detenida. Pret. tóppi, tópessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toppé', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. agüita. ; na na''a quiero un poco de agua. toppí, dim. pl. genitales femeninos pequeños. . tóppi, pret. v. o tóppa ; to bo - o botyo e I Í lmetyi o hemos atado a la persona detenida', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topuá', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. perritos, chuchos. . topuessi, pret. v. o topólla ; to - e be''e la a batyo nosotros desa tábamos las cargas y a las personas', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('topúm', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cucharas. . Tb. tiihá', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topúrúu', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. puertecitas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('topussu', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. juegos, diversiones. jugue tes. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('torábette', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. conejos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('torekká', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. manantiales, fuentes. . Tb. tiinekká. tori, pret. v. o tolla ; n i - i pillá moJí los dátiles, n-o hella ripotto tengo que ir a la ciudad', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('torí', 's.', NULL, NULL, NULL, NULL, 'pl. dotes, bienes del matrimonio. petición de mano y entrega de dote. Cl. lO', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toribolla', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. diablillos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toriia', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. aldeas, pueblecitos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tóritóri', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. cantoral de río. char latán, parlanchín. c) hablador, hablante. Cls. 9 y 10. totto / 319', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tornpulla', 'S.', NULL, NULL, NULL, NULL, 'sing. vaso de cristal, un vaso cual quiera. Cl. 9. Tb. akákka, etyakka. Topepé /317', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('torosíssi', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. pantalón. Cls. 9 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('toruerué', 's.', NULL, NULL, NULL, NULL, 'pl. grillos. charlatanes. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toruppe', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. arbolitos divinos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosási', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. tijeras. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tose''e', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. larvas, gusanitos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toseke', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. tabletas de madera, tablillas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toseseele', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. escobillas. . Tb. tobetye, toburúm', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosieráa', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. asociaciones, empresas. sociedades. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosokka', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. gorros, gorritas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosollo', 's.', NULL, NULL, NULL, NULL, 'pl. pequeña cantidad de sal. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosóló', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cerditos, cochinillos. jabatos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosoppo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. panecillos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosorí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cordeles, hilos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('tosuállo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. mujeriegos, pendones. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosula', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. coscorrones, capones. . Tb. biakóo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tosússu', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. zapatitos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totáa', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. batutas. nalguitas. . totaella, v. aliviar, calmar; ii biilallo bii lA le - el medicamento ali via mi dolor. Pret. totaeri, totaelessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totaeta''e', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. hongos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totappá', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. presunciones, orgullos, altanerías. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totattá', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. membranas, pequeñas pieles. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totátyi', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. almidones. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totebótyo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. dibujos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totebú', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. castañas. Cl. 13. Tb. tokápáa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totee', 'adj.', NULL, NULL, NULL, NULL, 'pl. grandes, voluminosos, importantes, destacados. Concuerda con las palabras de la Cl. 13; ii tiiiikiillii - los picantes grandes', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totelle', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. senderos, caminitos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toteppe', 's.', NULL, NULL, NULL, NULL, 'pl. tabiquitos, tabiques finos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totéppi', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. sujetadores. Cl. 13. Tb. apá ''a. totessi, prel. v. o tóttáa ; ne - a batyii bá''a pooi bA me dirigía a las personas que llegaron', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('toteteri', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. cortes pequeños. minutos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totímma', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. barcos, buques, naves, navíos. . tto', NULL, 'bio', 'Fuente: bubi-español', 'import-script'),
 ...
 ('tottó', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. despensas, almacenes. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totubbá', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. partículas, lotes. migaj as. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('totúkká', 's.', NULL, NULL, NULL, NULL, 'pl. cestos, cestitas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totúkku', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. jefecillos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totúllá', 's.', NULL, NULL, NULL, NULL, 'pl. islas, isletas, islotes. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totúllu', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. orinales. . Tb. ipó', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyakalébbo', 's.', NULL, NULL, NULL, NULL, 'pl. objetos pequeños que pue den aparecer bajo muy diversas formas, que con tienen pequeños elementos en su interior. sona jeros, cascabeles, maracas. CL 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyappa', 's.', NULL, NULL, NULL, NULL, 'pl. comuniones, hostias. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyaptme', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. flautitas, trompetitas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyatyá', 's.', NULL, NULL, NULL, NULL, 'sing. dados. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyatyapellé', 's.', NULL, NULL, NULL, NULL, 'pl. bicicletas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyatyó', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. chismosos, chivatos, cotillas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyetyee', 's.', NULL, NULL, NULL, NULL, 'pl. destellos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyí', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. caracol. Cls. 9 y 10. totyíi, pret. v. o tóttáa ; n- a batyo ba lá púlláa ba ripotto salí al encuentro de las personas que vienen de la ciudad', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyo', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. personas pequeñas, personitas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyóbbo', 's.', NULL, NULL, NULL, NULL, 'pl. casitas, casitas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyoru', 's.', NULL, NULL, NULL, NULL, 'pl. corderos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyotyo', 's.', NULL, NULL, NULL, NULL, 'pl. ballenatos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('totyué', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. pescaditos. . tówálessi, pret. v. o tówálla ; oberii ID a le - kóri n tyí''a pooi bakasso mi madre me regañaba porque no llegué pronto. tówálla, v. 1. reprender, regañar; n la - o bui tyíi ID regaño a mi hermani to. 2. hablar con alguien; a batyo ba la - o botúk ku las personas hablan con el alcalde. Pret. tówám, tówálessi. tówám, pret. v. o tówálla ; o bonatú''o o o - tu herma no mayor te reprendió. tówe''em, pret. v. o tówella ; o obu laella a - i hMmá el defensor hablaba por los mudos. tówelessi, pret. v. o tówella ; o obu laella a - i hMmá el defensor hablaba por los mudos. tówella, v. hablar por otro; o bOíe a la - o bollá áí el padre habla por su hijo. Pret. tówe''em, tówem. tówem, pret. v. o tóweIla ; o obulaella a - i hMmá el defensor habló por los mudos. tóweri, pret. v. o tówella ; o bulla bo e eriia bo - a basesepári la doncella del pueblo habló por las mozas. towessi, pret. v. o t; n-e enkeléssi yo habla ba inglés, n-e ekará yo hablaba el inglés, o - e epanná tú habla bas e', NULL, 'tówelessi', 'Fuente: bubi-español', 'import-script'),
 ...
 ('tua''á', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. bastones, varas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tua''u', 's.', NULL, NULL, NULL, NULL, 'pl. poca cantidad de bebida alcohólica. Cl. 13. tuilipássi / 321', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuáám', 's.', NULL, NULL, NULL, NULL, 'pl. finquitas, huertecillos. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuaatyé', 's.', NULL, NULL, NULL, NULL, 'pl. camillas, catres. Cl. 1 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuái', 's.', NULL, NULL, NULL, NULL, 'pl. saliva. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuaísso', 's.', NULL, NULL, NULL, NULL, 'pl. mujercitas, damitas. Cl. 13. Tb. tuatyanna. tuak. ká, s. pl. almendras pequeñas. compri midos, píldoras, grageas. bastones, cetros. Cl. 1 3. Tb. tomeressi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tualáa', 's.', NULL, NULL, NULL, NULL, 'pl. cáscaras del palmiste o de cualquier almendra. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('tuappé', 's.', NULL, NULL, 'Cl. 1', NULL, 'pl. hollejos secos en poca cantidad. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuáppo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. tiendas, abacerías, comercios. . Tb. bOteri (sing. roter, J', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuarí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. espositas, mujercitas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuaríolla', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. ancianitas, viejecitas. . Tb. tuarltyityi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuarityityi', 's.', NULL, NULL, 'Cl. 1', NULL, 'pl. ancianitas con mucha experien cia, viejecitas. 3. Tb. tuaríolla', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuataté', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. tiestos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuatée', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. laditos, trocitos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuátiré', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. sábados. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuatyanna', 's.', NULL, NULL, NULL, NULL, 'pl. mujercitas, espositas. Cl. 13. Tb. tuaísso', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuauto''o', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. frascos, petacas. . Tb. totó''o, tamma. túbaera, v. decir; o la - botyo alo e bilabba bi lá etta lá le dices a alguien cómo van las cosas. Pret. túbaeria, túbaeresiia. Tb. o bOl/á. túbaeresüa, pret. v. o túbaera ; a banatú''ó ba áó ba e - alo to pénnesa lá nuestros hermanos mayores nos decían lo que debíamos hacer. túbaería, pret. v. o túbaera ; n ba - a batyo ná ba pélle i tyóbbo i ábó wela les dije a las personas que permanecieran en sus casas. tue, pref sujo nosotros, nosotras; - batyo somos personas. túe, prono nosotros, nosotras; - tue batyo ba e eriia nosotros somos pai sanos', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tue''i', 'S.', NULL, NULL, 'Cl. 12', NULL, 'pl. 1. barro/s rojo/s. 2. límites. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuebáám', 'S.', NULL, NULL, NULL, NULL, 'pl. hojas, papeles. Cl. 1 3. Tb. tonta', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuebbe', 'S.', NULL, NULL, 'Cl. 13', NULL, 'pl. aguiluchos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuebbe', 'S.', NULL, NULL, 'Cl. 12', NULL, 'pl. embarazos de pocas semanas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tueéIe', 'S.', NULL, NULL, 'Cl. 13', NULL, 'pl. personas débiles, personas indefensas y apocadas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuehehi', 'S.', NULL, NULL, 'Cl. 12', NULL, 'pl. calmas, amaines. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tueké', 'adj.', NULL, NULL, 'Cl. 12', NULL, 'pl. necios, tontos, bobalicones, igno rantes. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tuenena', 'S.', NULL, NULL, 'Cl. 12', NULL, 'pl. hormigas menudas. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tueppo', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. músicas, melodías. Cl. 13. Ej. expr. we bOlle ná o - to aríi e ehullá áó no permitas que las melodías nos dejen sin aliento', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuettáa', 'S.', NULL, NULL, 'Cl. 1', NULL, 'pl. plumas. cuchillos. nava jas. 3. Tb. /o''obbá, to''obbá', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuetue', 'adj.', NULL, NULL, 'Cl. 13', NULL, 'pl. bellos, bonitos, buenos, hermosos, agradables. Concuerda con las palabras de la ; o tokkó - las buenas noticias', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuetyi', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. antílopes. Cl. 13. Tb. tobillo. túhía, pret. V. o túhia ; ne - eló empa presté este asiento. túhia, V. prestar; n la - e sótte Ól yo presto mi camisa. Pret. túhía, tú hiesiia. túhiesiia, pret. V. o túhia ; n-e ebuttá ó yo prestaba tu sombrero', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuibbO', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. diablillos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuiítyi', 's.', NULL, NULL, 'Cl. 12', NULL, 'pl. dedos meñiques. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('tuikíro', 's.', NULL, NULL, NULL, NULL, 'pl. pequeños movimientos. bai les, fiestas. Cl. 1 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuilipássi', 's.', NULL, NULL, NULL, NULL, 'pl. chancletas. Cl. 13. 322 / tuille', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuille', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. frío abundante. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuimmí', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. camisones. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuió', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. hormigas negras medianas. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuíoo', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. fueguecillos de tres piedras. pequeños fogones. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('túke', 'adj.', NULL, NULL, NULL, NULL, 'pl. muchos, abundantes. Concuerda con las palabras de la Cl. 13; tobelo - antílopes muchos. tukessi, pret. v. o tukka ; to ba - a boppé nosotros removíamos el agua, lo bi - e bilabba vosotros removíais los hechos. tukka, v. remover, enturbiar, revolver; o la - a boppé tú revuelves el agua. fastidiar; o la - e bilabba tú fastidias las cosas. Pret. tukki, tu kessi. tukki, pret. v. o tukka ; to ba - a biitá nosotros removimos el aceite', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tukku', 's.', NULL, NULL, NULL, NULL, 'pl. pequeñas selvas. Cl. 13. tukolla, v. aclarar, depurar; o boebba a la - a boppé el vinatero depura el agua. Pret. tukori, tukuessi. tukora, v. contentar; o botúkku a la - a batyo ba mmaa bá e eriia wela el alcalde con tenta a todos los habitantes del pueblo. arre glar; to la - e tyóbbo noso tros arreglamos la casa. Pret. tukori, tukuessi. tukori, 1. pret. v. o tukora ; o botúkku a - a batyo el alcalde contentó a la gente, to - o wettya nosotros arreglamos la cabaña. 2. pret. v. o tukol1a ; o boebba a - a boppé el vinatero depuró el agua. T', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('túllée', 'S.', NULL, NULL, 'Cl. 12', NULL, 'pl. tortugas de bosque. Cl. 13', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tulufáto', 'S.', NULL, NULL, 'Cl. 12', NULL, 'pl. sulfatos, insumos. Cl. 13. tupelOlessi, pret. V. o tupelolla ; o lohebbO lo - a balakOláko el descanso desentumecía a los trabajadores. tupelOlla, v. desentumecer; n la - e hNko ID yo desentumezco mi cuello. Pret. tupelori, tupelOlessi. tupelori, pret. V. o tupelolla ; o IOhebbO 10 - e bene be a batyo el descanso desentume ció los dedos de la gente. tupessi, pret. V. o tuppa ; n -la o lOetto me cansaba con el trayecto. Tb. tyibessi. tupiáera, V. 1. apoyar; imp. we le tupiáere no me apoyes. 2. apuntalar; preso to la - e rikobbe nosotros apuntalamos el árbol del plátano. 3. enlazar; o la - e beatta tú enlazas las historias. Pret. tupiáeriia, tupiáeresiia. tupiáeresüa, pret. V. o tupiáera ; ne - e tyóbbo yo apuntalaba la casa. tupiáeriia, pret. V. o tupiáera. tupiesiia, pret. V. o tuppia ; o bOie áó e la o lOetto nuestro padre nos cansaba con el trayecto. tupiia, pret. v. o tuppia ; elo elako e le este trabajo me cansó. tupOlessi, pret. V. o tupolla ; o tollo to le - el sueño me hacía', NULL, 'o tyib báa', 'Fuente: bubi-español', 'import-script'),
 ('tuppá', 's.', NULL, NULL, NULL, NULL, 'pl. balones, pelotas. encuentros de f útbol. Cl. 13. tyebbá / 323 tuppi, pret. v. o tuppa ; to -la o lOetto nos cansamos con el trayecto. tuppia, v. cansar, agotar; o lOetto 10 la le - el trayecto me cansa, me agota. Pret. tupiia, tupiesiia', NULL, 'tyíbbi', 'Fuente: bubi-español', 'import-script'),
 ('tuppio', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. apoyos, soportes. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('túppu', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. salsas, caldos. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tutta', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. hojas, papeles. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuttú', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. orujo húmedo del dátil, holle jo. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tuua', 's.', NULL, NULL, 'Cl. 13', NULL, 'pl. vendas, telas finas. . tya, 1. adv. hasta, solamente; - bá batyo ha tyí solamente están estas personas. 2. adj. numo tres; nabba - tres animales, ketto - o ket to yé - tres veces. 3. morj. " neg. no; n-la pupúl la no madrugo. 4. loe. adv. más que a -la to''ólla - e tyo no habla más que el bubi. Concuerda con las palabras de las Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tyakkí', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. pitos, cornetas. Cls. 9 y 10 ; to la óppa i - tocamos los pitos', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyákkó', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. remo. Cls. 9 y 10. Ej. expr. -- bue le bó etya remo remo le hace avanzar. tyakóbia, v. hacer ruido al masticar un ali mento, ronchar. Pret. tyakóbiia, tJakóbiesiia. tyakóbiesiia, pret. v. o tyakóbia ; o biSyólla a - o tolló wela el abuelo ronchaba en el sueño. tyakóbiia, pret. v. o tyakóbia ; sé sibél ló n - hace un momento ronché', NULL, 'kappí', 'Fuente: bubi-español', 'import-script'),
 ('tyakumá', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. verruga/s. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyáló', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. pelo blanco, canas. . Tb. tyánnó', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyánnó', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. canas, pelo blanco. . Tb. tyáló. tyap¡me, s. sing y pl. flauta, trompeta. y 10', NULL, 'tyepelle', 'Fuente: bubi-español', 'import-script'),
 ('tyappa', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. semilla grande con vaína. se usa a veces como sonajero. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyaróm', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. cárceles, prisiones, peniten ciarías, calabozos, celdas. Cls. 9 y 10', NULL, 'tyéUi', 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('tyaUá', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. 1. hambre, hambruna. 2. cha pa de zinc. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyé', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. país, patria, nación. territo rio, lugar. Cls. 9 y 10 ; 0 en el mundo, en la vida, ké - we é? ¿dónde estás?', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyé''a', 's.', NULL, NULL, NULL, NULL, 'pl. hojas comestibles de la berenjena. Cl. lO ; i - ya haríbbO las hojas no comestibles de la berenjena', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyebbá', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. sueño/s. Cls. 9 y 10. 324 / tyebólla', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyebólla', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. jabón/jabones, detergen te/s. Cls. 9 y 10', NULL, 'sóppo', 'Fuente: bubi-español', 'import-script'),
 ...
 ('tyekka', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. cordón que se ata en el tobi llo. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyekke', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. orugas de la palmera de aceite. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyekkú', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. ombligo. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('tyelle', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. gajo. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyélle', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. cárcel, prisión, penitenciaría, calabozo, celda. Cls. 9 y 10', NULL, 'tyaróm', 'Fuente: bubi-español', 'import-script'),
 ('tyello', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. cascada/s, salto/s de agua. Cls. 9y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyenó', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. agua de cascada, chorro. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyepelle', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. flautas. Cls. 9 y 10', NULL, 't yapelle', 'Fuente: bubi-español', 'import-script'),
 ('tyerú', 's.', NULL, NULL, 'Cl. 10', NULL, 'pl. nipas, chapas de zinc. ', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyetye', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. espina/s, púa/s. Cls. 9 y 10. Tb. lonorí', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('tyonnó', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. lugar recóndito, rincón. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyooa', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. termitas blancas, comején. Cls. 9 y 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyoom', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. vergüenza, rubor. Cls. 9 y 10. E}. expr. o tyí o''áa - no tienes vergüenza. tyopálessi, pret. v. o tyopálla ; e kólló ne - néri yo pinchaba la rata de bosque con un clavo. tyopálIa, v. pinchar con algo; to la - o bora''o tokko nosotros pin 328 / tyopári chamos la comida con un clavo. Pret. tyopári, tyopálessi. tyopári, pret. v. o tyopálla ; n pinché con algo, o - pinchaste con algo, a - pinchó con algo, to - pinchamos con algo, 10 - pinchas teis con algo, ba - pincharon con algo. tyopessi, pret. v. o tyoppáa ; n-yo pinchaba, o - tú pinchabas, a - él pinchaba, to - nosotros pinchábamos, 10 - voso tros pinchabais, ba - ellos pin chaban', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyoppá', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. faj os de billetes. Cls. 9 y ID. tyoppáa, v. picar, pinchar, punzar. for nicar. Pret. tyoppíi, tyopessi', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyóppe', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. hachas grandes. Cls. 9 y 10. tyoppíi, t. s. sing. y pl. puntas. Cls. 9 y 10. 2. pret. v. o tyoppáa', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('tyoppo', 's.', NULL, NULL, NULL, NULL, 'sing. y pl. loco, trastornado, chifla do, chalado. locura, demencia. Cls. 9 y 10; 010 botyo e - esta persona está loca, trastornada', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
...
INSERT INTO dictionary_entries (
 ...
 ('wanapana', 's.', NULL, NULL, NULL, NULL, 'sing. estudiante, alumno. persona con conocimiento. Cl. 1. wanná, int. ¡cuidado!', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('waótalla', 's.', NULL, NULL, NULL, NULL, 'sing. un duro. Cl. 3. warí, 1. s. sing. mujer, esposa. el. I. Tb. muára, waísso, muadyána. 2. pret. v. o walláa ; a batyo ba mm aa ba - e tyal lá todas las per sonas murieron de hambre', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('wásibé', 's.', NULL, NULL, NULL, NULL, 'sing. topo del inglés west bay, hoy Lubá. Cl. 3; 0-Lubá, n la helláa o - voy a Lubá', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('wátéte', 'S.', NULL, NULL, NULL, NULL, 'pl. camaleón. Cl. 10', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('watya', 'S.', NULL, NULL, NULL, NULL, 'sing. picor, quemazón. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('watyatya', 'S.', NULL, NULL, NULL, NULL, 'sing. brillo, centelleo, que tiene buen aspecto. Cl. 3. Tb. ebuera buera', NULL, NULL, 'Fuente: bubi-español', 'import-script');
...
INSERT INTO dictionary_entries (
 ...
 ('webba', 'S.', NULL, NULL, NULL, NULL, 'sing. eructo, regurgitación. Cl. 3. Tb. buebá', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('webbe', 'S.', NULL, NULL, NULL, NULL, 'sing. congoja, tristeza. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('wehá', 'S.', NULL, NULL, NULL, NULL, 'sing. árbol que da el fruto IIamado rehá parecido al melocotón. Cl. 3. Tb. buehá. wéi, pret. v. o wáa ; i ko''e ku baa i - la o bokaaí todas las gallinas murieron por la plaga', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('wellá', 'S.', NULL, NULL, NULL, NULL, 'sing. lluvia. Cl. 3. Tb. l óllá', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('welláa', 's.', NULL, NULL, NULL, NULL, 'sing. vientre, barriga, estómago. Cl. 3', NULL, 'buelláa', 'Fuente: bubi-español', 'import-script'),
 ('welle', 'S.', NULL, NULL, NULL, NULL, 'sing. salud. Cl. 3; ne - estoy bien de salud', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('wem', 'S.', NULL, NULL, NULL, NULL, 'sing. vino. Cl. 3. Tb. wilóbíllo', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('werí', 'S.', NULL, NULL, NULL, NULL, 'sing. hormiga roja grande. carácter, temperamento, forma de ser. Cl. 3. witáeri / 339', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('wetta', 's.', NULL, NULL, NULL, NULL, 'sing. hermana, prima. Cl. 1', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('wettya', 's.', NULL, NULL, NULL, NULL, 'sing. cabaña, choza, *casa. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('wetyetyú', 's.', NULL, NULL, NULL, NULL, 'sing. lagarto, lagartija. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('wewe', 's.', NULL, NULL, NULL, NULL, 'sing. y adj. guapo/a, bello/a, hermoso/a. el. I. wihó, 1. s. sing. rebeldía, travesura, testarudez. 2. adj. cabezudo, cabezota. Cl. 3', NULL, 'buihó', 'Fuente: bubi-español', 'import-script'),
 ('wikíra', 's.', NULL, NULL, NULL, NULL, 'sing. 1. columpio. 2. movimiento. Cl. 3. Tb. esikiri', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ...
 ('wilówillo', 's.', NULL, NULL, NULL, NULL, 'sing. vino tinto. Cl. 3. Tb. wem. wínaam, pret. v. o wínanna ; a baie ba - e bittá los hombres ganaron la guerra. wínanesia, pret. v. o wínanna ; n bo - o wéso''o lÍl yo ganaba a mi amigo. wínanna, v. ganar, vencer; 10 la - a batyo ba mmaa vosotros ganáis a todos. Pret. wínaam, wínanesia', NULL, 'o ló''a', 'Fuente: bubi-español', 'import-script'),
 ('winoo', 's.', NULL, NULL, NULL, NULL, 'sing. energía, fuerza, facultad, autoriza ción. Cl. 3. Tb. t(j''ú', NULL, NULL, 'Fuente: bubi-español', 'import-script'),
 ('witáeri', 's.', NULL, NULL, NULL, NULL, 'sing. encuentro, concentración. Cl. 3', NULL, NULL, 'Fuente: bubi-español', 'import-script');
